	...
	?>
                <div class="item <?=$cls;?>">
                    <div class="thumbnail">
					<?php if($val->link=="") { ?>
                      <img src="<?=base_url();?>assets/media/banner/<?=$val->id_konten;?>/<?=$val->foto;?>">
					<?php } else { ?>
                      <a href="http://<?=$val->link;?>" target=_blank border=0><img src="<?=base_url();?>assets/media/banner/<?=$val->id_konten;?>/<?=$val->foto;?>"></a>
					<?php } ?>
                    </div>        
                </div><!-- End Item -->
	<?php
