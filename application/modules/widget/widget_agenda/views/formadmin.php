        <tr id="pilmenu" style="display:none;">
			<td colspan=8><input type=checkbox name="widget_isi[]" id="widget_isi" value='ss' checked></td>
		</tr>
        <tr id="opsi_X_0">
		  ...
		  <input type="text" name="nilai[0]" value="<?=@$nilai[0];?>" class="form-control">
		  </td>
        </tr>
        <tr id="opsi_X_1">
		  ...
		  <input type="text" name="nilai[1]" value="<?=@$nilai[1];?>" class="form-control">
		  </td>
        </tr>
        <tr id="opsi_X_2">
