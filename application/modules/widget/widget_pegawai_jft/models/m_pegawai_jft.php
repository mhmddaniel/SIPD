<?php
class M_pegawai_jft extends CI_Model{
	function __construct(){
		parent::__construct();
		date_default_timezone_set('Asia/Jakarta');
	}
///////////////////////////////////////////
	function get_jft($unor="all",$pns="all",$jabatan="all",$gender="all"){
		...
		$sqlstr="SELECT
					...
					WHERE
					r_pegawai_aktual.kode_unor = 02.03 AND
					r_pegawai_aktual.jab_type LIKE '%jft%' AND
					r_peg_dokumen.tipe_dokumen LIKE '%pasfoto%' AND
					r_pegawai_aktual.nomenklatur_jabatan NOT LIKE '%guru%'
					ORDER BY
					r_pegawai_aktual.nama_golongan DESC";
