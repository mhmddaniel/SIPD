...
class Kanal extends MX_Controller {
	...
	public function detil_kanal_json($id_kanal,$anak){
		...
		$data['logo'] = base_url().$header->nama_item;
	...
	public function formeditheader(){
		...
		$tpl_1= Modules::run("cmshome/height_options",@$data['header']->tinggi_header);
		$data['tinggi_header']="<select id='tinggi_header' name='tinggi_header'  class='form-control'>".$tpl_1."</select>";
		$tpl_1= Modules::run("cmshome/margin_options",@$data['header']->margin_top);
		$data['margin_top']="<select id='margin_top' name='margin_top'  class='form-control'>".$tpl_1."</select>";
		$tpl_1= Modules::run("cmshome/margin_options",@$data['header']->margin_bottom);
		$data['margin_bottom']="<select id='margin_bottom' name='margin_bottom'  class='form-control'>".$tpl_1."</select>";
		$tpl_1= Modules::run("cmshome/margin_options",@$data['header']->padding_top);
		$data['padding_top']="<select id='padding_top' name='padding_top'  class='form-control'>".$tpl_1."</select>";
		$tpl_1= Modules::run("cmshome/margin_options",@$data['header']->padding_bottom);
		$data['padding_bottom']="<select id='padding_bottom' name='padding_bottom'  class='form-control'>".$tpl_1."</select>";
