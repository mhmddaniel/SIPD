<div class="row">
	<div class="col-lg-6">
		<div class="panel panel-success">
			<div class="panel-heading">FORM NON-AKTIFKAN PENGGUNA</div>
...
<table class="table table-striped">
       ...
       <tr >
          ...
          <td colspan="3">
				...
				<div onclick="simpan();" class='btn btn-danger btn-sm' id="btAct"><i class="fa fa-bell-slash-o fa-fw"></i> Non-Aktifkan</div>
...
////////////////////////////////////////////////////////////////////////////
	function simpan(){
		...
		if (hasil!=false) {
			...
			$.ajax({
				type:"POST",
				url:"<?=base_url();?>cmsadmin/user/nonaktifkan_aksi/",
