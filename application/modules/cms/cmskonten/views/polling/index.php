<div class="row">
	<div class="col-lg-12">
		...
		<div class="btn btn-warning btn-xs pull-right content_post" style="margin-top:10px;" onclick="buka('polling/formtambah','isi',0);"><i class="fa fa-plus fa-fw"></i> Tambah Post Item</div>
		</h3>
	</div><!-- /.col-lg-12 -->
</div><!-- /.row -->
								...
								<div class="col-lg-8" style="padding-top:8px;">
									<div class="dropdown"><button class="btn btn-primary dropdown-toggle btn-xs" type="button" id="ddMenuT" data-toggle="dropdown"><span class="fa fa-book fa-fw"></span></button>
										<ul class="dropdown-menu" role="menu" aria-labelledby="ddMenuT">
											...
											?>
											<li role="presentation" <?=($val->komponen=="polling")?'class="active"':'';?>><a href="<?=site_url('module/cmskonten/'.$val->komponen);?>" role="menuitem" tabindex="-1" style="cursor:pointer;"><i class="fa fa-<?=($val->komponen=="polling")?"check":"sign-out";?> fa-fw"></i> <?=$val->label;?></a></li>
											<?php
											}
											?>
										</ul>
