										...
										<div class="col-lg-6">
											<div class="dropdown"><button class="btn btn-primary dropdown-toggle btn-xs" type="button" id="ddMenuT" data-toggle="dropdown"><span class="fa fa-list fa-fw"></span></button>
												<ul class="dropdown-menu" role="menu" aria-labelledby="ddMenuT">
													<li role="presentation" class="active"><a role="menuitem" tabindex="-1" style="cursor:pointer;"><i class="fa fa-list fa-fw"></i> Data PNS Sinkron by NIP</a></li>
												...
												<span>Data PNS Sinkron by NIP</span>
											</div>
										</div>
										<div class="col-lg-6">
...
if($exec=="ya"){
?>
<a href="<?=site_url();?>module/csapk/impor/impor">impor</a>
<?php
}
?>
...
var batas = $('#item_length').val();
	$.ajax({
		type:"POST",
		url:"<?=site_url();?>csapk/impor/getdata",
