										...
										<div class="col-lg-6">
											<div class="dropdown"><button class="btn btn-primary dropdown-toggle btn-xs" type="button" id="ddMenuT" data-toggle="dropdown"><span class="fa fa-list fa-fw"></span></button>
												<ul class="dropdown-menu" role="menu" aria-labelledby="ddMenuT">
													...
													<li role="presentation" class="active"><a role="menuitem" tabindex="-1" style="cursor:pointer;"><i class="fa fa-list fa-fw"></i> Data NIP :: SAPK-Tidak Ada, SIPD-Ada</a></li>
													<li class="divider"></li>
												...
												<span>Data NIP :: SAPK-Tidak Ada, SIPD-Ada</span>
											</div>
										</div>
										<div class="col-lg-6">
											<a href="<?=site_url();?>csapk/cetak/sikda_ada" target="_blank"><div class="btn btn-primary btn-xs pull-right" id="bt_opsi" onclick="buka_div_opsi();"><i class="fa fa-print fa-fw"></i></div></a>
										</div>
								</div>
				</div><!-- /panel-heading -->
...
var batas = $('#item_length').val();
	$.ajax({
		type:"POST",
		url:"<?=site_url();?>csapk/impor/getsikda",
	...
	//tombol aksi<--
					...
					table = table+ "<td style='padding:3px;text-align:center'>"+item.tmt_cpns+"</br>"+item.tmt_pns+"</br><b>Aktif</b></td>";
					table = table+ "</tr>";
					no++;
