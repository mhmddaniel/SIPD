...
function isi(dok,prs){
			$.ajax({
				type:"POST",
				url:"<?=site_url();?>appmutasi/masuk_daftar_"+prs+"/"+dok,
				data:{"idd":"<?=$idd;?>"},
				beforeSend:function(){	
...
function viewUppl(komponen,idd){
	...
	var nip_baru = $('#nip_baru').html();
			$.ajax({
				type:"POST",
				url:"<?=site_url();?>appmutasi/masuk_daftar_edok/"+komponen+"_upload",
...
function uppl(bttn,stts,dokumen){	
		...
		new AjaxUpload(btnUpload, {
			action: '<?=site_url();?>appmutasi/masuk_daftar_edok/saveupload',
			name: 'artikel_file',
			data: {"komponen":komp,"idd":idd    },
...
function ok_hapus(tipe,idd){
	...
	var id_dokumen = $('#head_no_'+tipe).attr("data-id_dokumen");
			$.ajax({
				type:"POST",
				url:"<?=site_url();?>appmutasi/masuk_daftar_edok/hapus_dok",
...
function viewForm(komponen){
			$.ajax({
				type:"POST",
				url:"<?=site_url();?>appmutasi/masuk_daftar_edok/"+komponen+"_formedit",
				data:{"id_pegawai":"satu"},
				beforeSend:function(){	
					$('#accordion').hide();
					$('#formedok').show();
