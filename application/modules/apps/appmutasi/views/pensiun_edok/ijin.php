	...
	<div class="row">
			<div class="col-md-2">
				<div class="thumbnail">
					<div class="caption">
						<p>
						<?php if(isset($surat->nomor)){ if($group_name=="pengelola"){ if($pensiun->status=="draft" || $pensiun->status=="revisi"){	?><a href="#" class="label label-info" onclick="viewUppl('ijin','xx');return false;"><i class="fa fa-upload fa-fw"></i> Atur Dokumen</a><?php }	} }	?>
			...
			<div class="col-md-6">
				<div class="panel panel-info">
					<div class="panel-heading">
						<div class="row">
							<div class="col-lg-10"><b>Surat Ijin Pimpinan</b></div>
							<?php if($group_name=="pengelola"){  if($pensiun->status=="draft" || $pensiun->status=="revisi"){	?>
							<div class="col-lg-2">
								<div class="btn btn-primary btn-xs  pull-right" onclick="viewForm('ijin');return false;"><i class="fa fa-edit fa-fw"></i> Edit</div>
							</div>
							<?php } }	?>
						</div>
					</div>
