<form role="form" id="form_sk_jabatan" action="<?=site_url();?>appmutasi/masuk_daftar_edok/sk_jabatan_edit_aksi">
<div class="panel panel-info">
	...
	<div class="panel-body">
		...
		<div class="row" style="padding-top:15px;">
			...
			<div class="col-lg-3">
				<label>JABATAN</label>
				<input name="nama_jabatan" id="nama_jabatan" type=text class="form-control" value="<?=@$surat->nama_jabatan;?>">
			</div><!--//col-lg-3-->
		</div><!--row-->
		<div class="row" style="padding-top:15px;">
			<div class="col-lg-3">
		...
		<div class="row" style="padding-top:15px;">
			<div class="col-lg-6">
			        <button type="submit" class="btn btn-primary" onclick="simpan_sk_jabatan();return false;"><i class="fa fa-save fa-fw"></i> Simpan</button>
