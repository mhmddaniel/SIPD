<form role="form" id="form_sk_pangkat" action="<?=site_url();?>appmutasi/masuk_daftar_edok/sk_pangkat_edit_aksi">
<div class="panel panel-info">
	<div class="panel-heading">
		<i class="fa fa-edit fa-fw"></i> <b>Form SK PANGKAT</b>
	...
	<div class="panel-body">
		...
		<div class="row" style="padding-top:15px;">
			...
			<div class="col-lg-3">
				<label>PANGKAT</label>
				<input name="pangkat" id="pangkat" type=text class="form-control" value="<?=@$surat->pangkat;?>">
			</div><!--//col-lg-3-->
		</div><!--row-->
		<div class="row" style="padding-top:15px;">
			<div class="col-lg-3">
		...
		<div class="row" style="padding-top:15px;">
			<div class="col-lg-6">
			        <button type="submit" class="btn btn-primary" onclick="simpan_sk_pangkat();return false;"><i class="fa fa-save fa-fw"></i> Simpan</button>
