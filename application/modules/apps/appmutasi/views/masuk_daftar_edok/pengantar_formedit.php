<form role="form" id="form_pengantar" action="<?=site_url();?>appmutasi/masuk_daftar_edok/pengantar_edit_aksi">
<div class="panel panel-info">
	<div class="panel-heading">
		<i class="fa fa-edit fa-fw"></i> <b>Form Surat Pengantar dari Pimpinan</b>
	...
	<div class="panel-body">
		<div class="row">
			<div class="col-lg-3">
				...
				<input name="nama_pimpinan" id="nama_pimpinan" type=text class="form-control" value="<?=@$surat->nama_pimpinan;?>">
			</div>
			<!--//col-lg-3-->
			<div class="col-lg-9">
				<label>Jabatan</label>
		...
		<div class="row" style="padding-top:15px;">
			<div class="col-lg-6">
			        <button type="submit" class="btn btn-primary" onclick="simpan_pengantar();return false;"><i class="fa fa-save fa-fw"></i> Simpan</button>
...
function simpan_pengantar(){
		var dati="";
				...
				if( nmsk ==""){	dati=dati+"NAMA PIMPINAN tidak boleh kosong\n";	}
				if( idpd ==""){	dati=dati+"JABATAN PIMPINAN tidak boleh kosong\n";	}
