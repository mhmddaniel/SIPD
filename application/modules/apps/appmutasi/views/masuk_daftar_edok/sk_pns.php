	...
	<div class="row">
			<div class="col-md-2">
				<div class="thumbnail">
					<div class="caption">
						<p>
						<a href="#" class="label label-info" onclick="viewUppl('sk_pns','xx');return false;"><i class="fa fa-upload fa-fw"></i> Atur Dokumen</a>
						<?php if($thumb!="assets/file/foto/photo.jpg"){ ?><a href="#" class="label label-default" onclick="zoom_dox('sk_pns','0');return false;"><i class="fa fa-search fa-fw"></i> Zoom</a><?php } ?>
						</p>
					</div>
			...
			<div class="col-md-6">
				<div class="panel panel-info">
					<div class="panel-heading">
						<div class="row">
							<div class="col-lg-10"><b>SK PNS</b></div>
							<div class="col-lg-2">
								<div class="btn btn-primary btn-xs  pull-right" onclick="viewForm('sk_pns');return false;"><i class="fa fa-edit fa-fw"></i> Edit</div>
							</div>
						</div>
					</div>
					<div class="panel-body">
