<form role="form" id="form_sk_pns" action="<?=site_url();?>appmutasi/masuk_daftar_edok/sk_pns_edit_aksi">
<div class="panel panel-info">
	...
	<div class="panel-body">
		...
		<div class="row" style="padding-top:15px;">
			<div class="col-lg-6">
			        <button type="submit" class="btn btn-primary" onclick="simpan_sk_pns();return false;"><i class="fa fa-save fa-fw"></i> Simpan</button>
