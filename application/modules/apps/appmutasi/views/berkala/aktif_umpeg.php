...
<th style="width:160px;text-align:center; vertical-align:middle">STATUS</th>
...
var mkcpns = $('#a_mkcpns').val();
	...
	//tombol aksi-->
					...
					table = table+ "<td valign=top style='padding:3px 0px 0px 0px;' align=center>";
						...
						table = table+ '<span class="btn btn-success btn-xs"><i class="fa fa-check fa-fw"></i></span>' + ' Berkas sedang diproses';
						}
	...
	//tombol aksi<--
					...
					table = table+ "<td style='padding:3px;'>" +item.nama_pangkat+" ("+item.nama_golongan+")<br/>"+"Gaji pokok setelah berkala : <b>"+item.gaji_pokok+"</b> / bulan <br /> Masa kerja <b>"+item.mk_berkala_tahun+" tahun "+item.mk_berkala_bulan+" bulan</b>, terhitung mulai <b>"+item.tmt_cpns+" </b> <br/>"+"TMT gaji terakhir <b>"+item.tmt_gaji+" </b></td>";
