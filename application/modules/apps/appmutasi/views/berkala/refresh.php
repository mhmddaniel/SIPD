...
<div class="btn btn-info btn-sm" onclick="ppost();" id="mg_1">REFRESH</div> 
</div>
...
function ppost(){
	...
	var tahun = $('#tahun_act').html();
		$.ajax({
        type:"POST",
		url:"<?=site_url();?>appbina/laporan_cuti/index_hitung_aksi",
		data:{"bulan":bulan,"tahun":tahun },
		beforeSend:function(){	
			$('#mg_1').html('<i class="fa fa-spinner fa-spin fa-1x"></i>');
		},
