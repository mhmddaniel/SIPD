	...
	<div class="col-lg-6">
		<div class="panel panel-default">
			<div class="panel-heading">
				<i class="fa fa-user fa-fw"></i> <b>Pegawai</b>
				<a href="<?=site_url();?>appdok/cetak/index/<?=$val->id_pegawai;?>" target="_blank"><div class="btn btn-warning btn-xs pull-right">Cetak CV</div></a>
			</div>
...
function isib(dok,prs){
			$.ajax({
				type:"POST",
				url:"<?=site_url();?>appbangrir/ibel_"+prs+"/not_"+dok,
				data:{"id_pegawai":"<?=$id_pegawai;?>"},
				beforeSend:function(){	
					$('#collapseOne'+dok).html('<p class="text-center"><i class="fa fa-spinner fa-spin fa-5x"></i><p>');
				},
