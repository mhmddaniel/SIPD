...
$(document).ready(function(){
	viewUppl("penyesuaian_ijazah","uploadDok");
});

function uppl(bttn,stts,dokumen){	
		var komp = "ujian_dinas";
		...
		new AjaxUpload(btnUpload, {
			...
			name: 'artikel_file',
			data: { "id_pegawai": nip_baru,"komponen":"penyesuaian_ijazah","idd":<?=$acc->id_peg_penyesuaian_ijazah;?>    },
...
function viewUppl(komponen,idd){
	...
	var nip_baru = $('#nip_baru').html();
			$.ajax({
				type:"POST",
				url:"<?=site_url();?>appbangrir/pi_proses/uploadDok",
