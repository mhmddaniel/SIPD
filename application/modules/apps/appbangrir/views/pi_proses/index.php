...
<tbody id=listA>
	...
	<div id="paging_print" style="display:none;"></div>
		...
		<div class="row" style="padding-top:0px;"><div class="col-lg-12" style="text-align:right;"><a href="<?=site_url();?>module/appbangrir/pi_injek">injek</a></div></div>
</div><!-- /.content -->
...
function gridpagingA(hal){
	...
	//tombol aksi-->
					table = table+ "<td valign=top style='padding:3px 0px 0px 0px;' align=center>";
						...
						table = table+ '<li role="presentation"><a role="menuitem" tabindex="-1" style="cursor:pointer;" onClick="ppost('+item.id_pi+',\'pi_injek/edit\');"><i class="fa fa-pencil fa-fw"></i> Edit Data</a></li>';
						if(accIb.thumb=="assets/file/foto/photo.jpg"){
						table = table+ '<li role="presentation"><a role="menuitem" tabindex="-1" style="cursor:pointer;" onclick="ppost('+item.id_pi+',\'pi_injek/hapus\');"><i class="fa fa-trash fa-fw"></i> Hapus Data</a></li>';
						}
						table = table+ "</ul>";
						table = table+ "</div>";
						} else {
						table = table+ '<div class="btn btn-default btn-xs" onClick="ppost('+item.id_pi+',\'pi_proses/alih\');"><i class="fa fa-binoculars fa-fw"></i></div>';
						}
					table = table+ "</td>";
	//tombol aksi<--
					table = table+ "<td><div>";
					...
					table = table+ "<div style='clear:both'>";
					table = table+ "<div style='float:left; width:95px;'>Unit kerja</div>";
					table = table+ "<div style='float:left; width:10px;'>:</div>";
					...
					table = table+ "<div><div style='float:left; width:95px;'>Tgl. diajukan</div>";
					table = table+ "<div style='float:left; width:10px;'>:</div>";
					table = table+ "<div style='float:left;'>"+item.tg_aju+"</div>";
					table = table+ "</div>";
					table = table+ "<div style='clear:both'>";
					table = table+ "<div style='float:left; width:95px;'>Tgl. diterima</div>";
					table = table+ "<div style='float:left; width:10px;'>:</div>";
					...
					table = table+ '<a href="#" class="label label-info" onclick="ppost('+item.id_pi+',\'pi_proses/upl\'); return false;"><i class="fa fa-upload fa-fw"></i> Atur Dokumen</a><br/>';
										}
										if(accIb.thumb!="assets/file/foto/photo.jpg"){
...
function ppost(idd,act){
	...
	$('#sb_act').attr('action','<?=site_url();?>module/appbangrir/'+act);
	...
	var tab = tab + '<input type="hidden" name="asal" value="appbangrir/pi_proses">';
