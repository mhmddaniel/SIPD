...
?>
<form role="form" id="form_jadwal" action="<?=site_url();?>appbangrir/udin_edok/jadwal_edit_aksi">
<div class="panel panel-info">
	<div class="panel-heading">
		<i class="fa fa-edit fa-fw"></i> <b>Form Surat Keterangan Jadwal Sekolah Udiiin</b>
