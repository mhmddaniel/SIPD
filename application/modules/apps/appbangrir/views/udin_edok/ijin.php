	...
	<div class="row">
			<div class="col-md-2">
				<div class="thumbnail">
					<div class="caption">
						<p>
						<?php if(isset($surat->nomor)){ if($group_name=="pengelola"){ if($udin->status=="draft" || $udin->status=="revisi"){	?><a href="#" class="label label-info" onclick="viewUppl('ijin','xx');return false;"><i class="fa fa-upload fa-fw"></i> Atur Dokumen</a><?php }	} }	?>
