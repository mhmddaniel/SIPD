...
<div class="col-md-5" style="padding-top: 5px;padding-bottom: 15px;">
	<div class="panel panel-info">
		<div class="panel-heading">
			<div class="row">
				<div class="col-lg-10">
					<b><?=(isset($isi->sk_pns_nomor))?$isi->sk_pns_nomor:"...";?></b>
				</div>
				<div class="col-lg-2">
		...
		<div class="panel-body">
			<div class="row">
							...
							<div class="col-md-8" style="padding:5px;">
								...
								<div><input type=text class="form-control" value="<?=isset($isi->sk_pns_pejabat)?$isi->sk_pns_pejabat:'-';?>" disabled></div>
								<div><b>Tanggal SK:</b></div>
								<div><input type=text class="form-control" value="<?=isset($isi->sk_pns_tanggal)?date("d-m-Y", strtotime($isi->sk_pns_tanggal)):'-';?>" disabled></div>
								<div><b>TMT PNS:</b></div>
								<div><input type=text class="form-control" value="<?=isset($isi->tmt_pns)?date("d-m-Y", strtotime($isi->tmt_pns)):'-';?>" disabled></div>
							</div>
			</div>
		</div>
	</div>
