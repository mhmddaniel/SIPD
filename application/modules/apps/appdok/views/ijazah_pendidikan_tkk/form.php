<form role="form" id="form_ijazah_pendidikan_tkk" action="<?=site_url();?>appbkpp/profile/riwayat_pendidikan_<?=(isset($row->id_peg_pendidikan))?((isset($hapus))?"hapus":"edit"):"tambah";?>_aksi">
