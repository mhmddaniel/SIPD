...
<table width="670">
  <tr>
    <td><table width="670" >
	  ...
	  <tr>
			<td width="16"></td>			
			<td width="640" align="left">tentang  Cuti  Pegawai  Negeri  Sipil  dan  sesuai  dengan  Surat <?php echo $data['jabatan'];?> perihal Permohonan Cuti Ibadah Haji, dengan ini diberikan izin Cuti Ibadah Haji kepada Pegawai Negeri :</td>
	  </tr>
	  <br/>
      <tr>
		<td width="16"></td>
	  ...
	  <tr>
			<td width="16"></td>
			<td width="650" align="left">Terhitung mulai tanggal <?php echo $data['mulai'];?> sampai dengan tanggal <?php echo $data['sampai'];?> selama <?php echo $data['diff'];?>, dengan ketentuan sebagai berikut :</td>
	  </tr>
	  <tr>
			<td width="16"></td>
			<td width="640" align="left">1.		Sebelum Menjalankan Cuti Ibadah Haji,  wajib  menyerahkan  pekerjaannya  kepada  atasan</td>
	  </tr>
	  <tr>
			<td width="37"></td>
	  ...
	  <tr>
			<td width="16"></td>
			<td width="640" align="left">2.		Selama menjalankan cuti ibadah haji tersebut, tidak berhak atas tunjangan jabatan.</td>
	  </tr>
	  <tr>
			<td width="16"></td>
			<td width="640" align="left">3.		Setelah menjalankan Cuti ibadah haji,  wajib  melaporkan  diri  kepada  atasan  langsungnya </td>
	  </tr>
	  <tr>
			<td width="37"></td>
	  ...
	  <tr>
			<td width="23"></td>
			<td width="670" align="center">Demikian Surat Izin Besar ini dibuat untuk dipergunakan sebagaimana mestinya.</td>
	  </tr>
	  <br/>
	  <tr>
