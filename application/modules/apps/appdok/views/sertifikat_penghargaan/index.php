...
<?php
$jj = count($isi);
@$isi[$jj]->nama_penghargaan = '<div class="btn btn-primary btn-xs" onClick="viewForm(\''.$komponen.'\',\'tambah\',\'xx\');"><i class="fa fa-plus fa-fw"></i> Tambah</div>';
...
<div class="col-md-4" style="padding-top: 5px;padding-bottom: 15px;">
	<div class="panel panel-info">
		<div class="panel-heading">
			<div class="row">
				<div class="col-lg-10">
					<b><span><?=($i2+1);?></span>. <span><?=$isi[$i2]->nama_penghargaan;?></span></b>
				</div>
				<?php
				if($i2!=$jj){
				?>
				<div class="col-lg-2">
						<div class="btn-group pull-right">
							...
							<ul class="dropdown-menu pull-right" role="menu">
								<li onclick="viewForm('<?=$komponen;?>','edit','<?=$isi[$i2]->id_peg_penghargaan;?>');return false;"><a href="#"><i class="fa fa-edit fa-fw"></i> Edit</a></li>
								<?php if($isi[$i2]->gbr=="kosong"){ ?>
								<li class="divider"></li>
								<li onclick="viewForm('<?=$komponen;?>','hapus','<?=$isi[$i2]->id_peg_penghargaan;?>');return false;"><a href="#"><i class="fa fa-trash fa-fw"></i> Hapus</a></li>
								<?php } ?>
							</ul>
						</div>
				</div>
							...
							<div class="col-md-5" style="padding:5px;">
								...
								<div class="thumbnail">
									...
									<div class="caption" style="text-align:center;">
										<p>
										<a href="" class="label label-info" onclick="viewUppl('<?=$komponen;?>','<?=$isi[$i2]->id_peg_penghargaan;?>');return false;"><i class="fa fa-upload fa-fw"></i> Atur Dokumen</a>
										<a href="" class="label label-default" onclick="zoom_dok('<?=$komponen;?>','<?=$isi[$i2]->id_peg_penghargaan;?>');return false;"><i class="fa fa-search fa-fw"></i> Zoom</a>
										</p>
									</div>
									<?php
									}
