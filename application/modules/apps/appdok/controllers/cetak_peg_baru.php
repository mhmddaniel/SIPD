...
class Cetak_peg_baru extends MX_Controller {
...
//		$this->load->model('appbkpp/m_pegawai');
	...
	function getdata($id_pegawai=false){
		...
		$data['pribadi'] = Modules::run("appbkpp/profile/ini_pegawai_master",$id_pegawai);
		$html['pribadi'] = $this->load->view('cv/pribadi_baru',array('data'=>$data['pribadi']),true );
