...
class Satu_jfu extends MX_Controller {
...
////////////////////////////////////////////////////////
	function index(){
		...
		$this->load->view('satu_jfu/index',$data);
	}
	...
	function rincian(){
		...
		$this->load->view('satu_jfu/rincian',$data);
	}
	function getrincian(){
		$cari = $_POST['cari'];
		$idd = $_POST['idd'];
		...
		$data['count'] = $this->m_satu->hitung_peg('jfu',$cari,$idd,$unor);
		...
		if($data['count']==0){
			...
			$data['hslquery'] = $this->m_satu->get_peg('jfu',$mulai,$batas,$cari,$idd,$unor);
			$data['pager'] = Modules::run("crest/pager/pagerC",$data['count'],$batas,$hal);
		}  //end if
