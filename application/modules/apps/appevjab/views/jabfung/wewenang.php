	...
	<div class="col-lg-12">
		<div class="panel panel-default">
			<div class="panel-heading">
					<div class="row">
						<div class="col-lg-10">
							<div class="dropdown"><button class="btn btn-primary dropdown-toggle btn-xs" type="button" data-toggle="dropdown"><i class="fa fa-qrcode fa-fw"></i></button>
								<ul class="dropdown-menu" aria-labelledby="ddMenuT" role="menu">
									...
									<li><a href="<?=site_url();?>module/appevjab/jabfung/tanggungjawab"><i class="fa fa-shield fa-fw"></i> Tanggungjawab</a></li>
...
function setF(tujuan,idd,no){
	var kop = []; 
	kop['formtambah'] = "FORM TAMBAH WEWENANG"; 
	kop['formedit'] = "FORM EDIT WEWENANG"; 
	kop['formhapus'] = "FORM HAPUS WEWENANG"; 
	var act = []; 
	act['formtambah'] = "<?=site_url();?>appevjab/jabfung/wewenang_tambah_aksi";
	act['formedit'] = "<?=site_url();?>appevjab/jabfung/wewenang_edit_aksi";
	act['formhapus'] = "<?=site_url();?>appevjab/jabfung/wewenang_hapus_aksi";
	var btt = []; 
	...
	btt['formhapus'] = "<button id='btAct' type=sumbit class='btn btn-danger' onclick='ajukan(); return false;'><i class='fa fa-trash fa-fw'></i> Hapus</button>"; 
			$.ajax({
			type:"POST",
			url:"<?=site_url();?>appevjab/jabfung/wewenang_"+tujuan,
			data:{"idd": idd,"no": no },
			beforeSend:function(){	
				$("#pageKonten").hide();
