	...
	<div class="col-lg-12">
		<div class="panel panel-default">
			<div class="panel-heading">
					<div class="row">
						<div class="col-lg-10">
							<div class="dropdown"><button class="btn btn-primary dropdown-toggle btn-xs" type="button" data-toggle="dropdown"><i class="fa fa-shield fa-fw"></i></button>
...
function setF(tujuan,idd,no){
	var kop = []; 
	kop['formtambah'] = "FORM TAMBAH TANGGUNGJAWAB"; 
	kop['formedit'] = "FORM EDIT TANGGUNGJAWAB"; 
	kop['formhapus'] = "FORM HAPUS TANGGUNGJAWAB"; 
	var act = []; 
	act['formtambah'] = "<?=site_url();?>appevjab/jabfung/tanggungjawab_tambah_aksi";
	act['formedit'] = "<?=site_url();?>appevjab/jabfung/tanggungjawab_edit_aksi";
	act['formhapus'] = "<?=site_url();?>appevjab/jabfung/tanggungjawab_hapus_aksi";
	var btt = []; 
	...
	btt['formhapus'] = "<button id='btAct' type=sumbit class='btn btn-danger' onclick='ajukan(); return false;'><i class='fa fa-trash fa-fw'></i> Hapus</button>"; 
			$.ajax({
			type:"POST",
			url:"<?=site_url();?>appevjab/jabfung/tanggungjawab_"+tujuan,
			data:{"idd": idd,"no": no },
			beforeSend:function(){	
				$("#pageKonten").hide();
...
function batal(aksi,idd){
	$('#sb_act').attr('action','<?=site_url();?>module/appevjab/jabatan/fungsional');
