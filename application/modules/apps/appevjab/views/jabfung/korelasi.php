	...
	<div class="col-lg-12">
		<div class="panel panel-default">
			<div class="panel-heading">
					<div class="row">
						<div class="col-lg-10">
							<div class="dropdown"><button class="btn btn-primary dropdown-toggle btn-xs" type="button" data-toggle="dropdown"><i class="fa fa-refresh fa-fw"></i></button>
								<ul class="dropdown-menu" aria-labelledby="ddMenuT" role="menu">
									...
									<li><a href="<?=site_url();?>module/appevjab/jabfung/prestasi"><i class="fa fa-trophy fa-fw"></i> Standar Prestasi Kerja</a></li>
								</ul>
								<b>KORELASI JABATAN</b>
							</div>
						</div>
						<div class="col-lg-2">
...
<table class="table table-striped table-bordered table-hover">
	<thead>
		<tr>
			...
			<th style="width:150px;text-align:center; vertical-align:middle">JABATAN</th>
			<th style="width:150px;text-align:center; vertical-align:middle">UNIT KERJA / INSTANSI</th>
			<th style="text-align:center; vertical-align:middle">DALAM HAL</th>
		</tr>
	</thead>
	<tbody>
	<?php
	foreach($korelasi AS $key=>$val){
	?>
		<tr>
			<td><?=$key+1;?></td>
			<td>
...
<li role="presentation"><a role="menuitem" tabindex="-1" style="cursor:pointer;" onClick="setF('formedit',<?=$val->id_korelasi;?>,<?=$key+1;?>);"><i class="fa fa-edit fa-fw"></i> Edit data</a></li>
<li role="presentation"><a role="menuitem" tabindex="-1" style="cursor:pointer;" onClick="setF('formhapus',<?=$val->id_korelasi;?>,<?=$key+1;?>);"><i class="fa fa-trash fa-fw"></i> Hapus data</a></li>
</ul>
</div>
			</td>
...
function setF(tujuan,idd,no){
	var kop = []; 
	kop['formtambah'] = "FORM TAMBAH KORELASI JABATAN"; 
	kop['formedit'] = "FORM EDIT KORELASI JABATAN"; 
	kop['formhapus'] = "FORM HAPUS KORELASI JABATAN"; 
	var act = []; 
	act['formtambah'] = "<?=site_url();?>appevjab/jabfung/korelasi_tambah_aksi";
	act['formedit'] = "<?=site_url();?>appevjab/jabfung/korelasi_edit_aksi";
	act['formhapus'] = "<?=site_url();?>appevjab/jabfung/korelasi_hapus_aksi";
	var btt = []; 
	...
	btt['formhapus'] = "<button id='btAct' type=sumbit class='btn btn-danger' onclick='ajukan(); return false;'><i class='fa fa-trash fa-fw'></i> Hapus</button>"; 
			$.ajax({
			type:"POST",
			url:"<?=site_url();?>appevjab/jabfung/korelasi_"+tujuan,
			data:{"idd": idd,"no": no },
			beforeSend:function(){	
				$("#pageKonten").hide();
