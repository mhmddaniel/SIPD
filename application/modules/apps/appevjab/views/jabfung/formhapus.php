  <div class="row">
	<div class="col-lg-12">
<form id="content-form" method="post" action="<?=site_url("appevjab/jabfung/hapus_aksi");?>" enctype="multipart/form-data" role="form">
				  ...
				  <div class="row">
					<div class="col-lg-12">
							<div class="form-group">
								...
								<input type="text" id="kode_bkn" name="kode_bkn" value="<?=@$unit->kode_bkn;?>" class="form-control" disabled>
							</div>
							<div class="form-group">
								<label>Nama jabatan fungsional</label>
								<input type="text" id="nama_jabatan" name="nama_jabatan" value="<?=@$unit->nama_jabatan;?>" class="form-control" disabled>
							</div>
