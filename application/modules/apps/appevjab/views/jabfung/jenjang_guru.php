	...
	<div class="col-lg-12">
		<div class="panel panel-success">
			<div class="panel-heading">
				<i class="fa fa-edit fa-fw"></i> <b>Jenjang Jabatan Guru</b>
...
<table class="table table-striped table-bordered table-hover">
	...
	<tbody>
	<?php 
	if(empty($jenjang)){	echo "<tr><td colspan=4 align=center>Tidak Ada Data</td></tr>";	} else {
		...
		<tr>
			...
			<div class="dropdown"><button class="btn btn-default dropdown-toggle btn-xs" type="button" data-toggle="dropdown"><i class="fa fa-caret-down fa-fw"></i></button>
				<ul class="dropdown-menu" role="menu">
					<li role="presentation"><a role="menuitem" tabindex="-1" style="cursor:pointer;" onClick="fJenjang('edit','<?="xx**".$val->id_jenjang_jabatan;?>');"><i class="fa fa-edit fa-fw"></i> Edit data</a></li>
					<li role="presentation"><a role="menuitem" tabindex="-1" style="cursor:pointer;" onClick="fJenjang('hapus','<?="xx**".$val->id_jenjang_jabatan;?>');"><i class="fa fa-trash fa-fw"></i> Hapus data</a></li>
				</ul>
			</div>
			</td>
			<td><?=$dWgolongan[$val->kode_golongan];?> - <?=$dWpangkat[$val->kode_golongan];?></td>
			<td><?=$val->tingkat;?> <?=$val->nama_jenjang;?></td>
		</tr>
	<?php	} } ?>
		<tr>
			<td colspan=2>&nbsp;</td>
			<td colspan=3><div class="btn btn-primary btn-xs" onclick="fJenjang('tambah','xx');"><i class="fa fa-plus fa-fw"></i> Tambah data</div></td>
		</tr>
	</tbody>
</table>
</div>
