<?php
class M_laporan_cuti extends CI_Model{
...
//////////////////////////////////////////////////////////////////////////////////
	function get_panel($idd,$blh,$thh){
		$sqlstr="SELECT * FROM r_peg_laporan_cuti_val WHERE id_setting='$idd' AND bulan=$blh AND tahun=$thh";
    ...
    function satu($ids,$nama,$isi,$bulan,$tahun){
		$sql = "SELECT id_item FROM r_peg_laporan_cuti_val WHERE id_setting='$ids' AND bulan='$bulan' AND tahun='$tahun'";
		$hsl = $this->db->query($sql)->row();
		if(empty($hsl)){
			$sqlstr="INSERT INTO r_peg_laporan_cuti_val (id_setting,nama_item,meta_value,bulan,tahun) VALUES ('$ids','$nama','$isi','$bulan','$tahun')";
			$this->db->query($sqlstr);
		} else {
			$sqlstr="UPDATE r_peg_laporan_cuti_val SET meta_value='$isi' WHERE id_item='".$hsl->id_item."'";
			$this->db->query($sqlstr);
		}
	}
//////////////////////////////////////////////////////////////////////////////////
