							...
							<div class="col-lg-6">
								<div class="panel panel-success">
									<div class="panel-heading">
										<div class="row">
												<div class="col-lg-6"><i class="fa fa-star fa-fw"></i> <b>FORM TAMBAH JAM KERJA</b></div>
												<div class="col-lg-6">
...
<form id="content-form" method="post" action="<?=site_url("appbina/harian/jam_kerja_tambah_aksi");?>" enctype="multipart/form-data" role="form">
<div class="row">
	<div class="col-lg-12">
								<div style="line-height:35px;">
										<div style="float:left; width:85px;">Jam Masuk</div>
										<div style="float:left; width:10px;">:</div>
										<span><div style="display:table;"><input type='text' class='form-control' name='jam_masuk'></div></span>
								</div>
								<div style="clear:both;line-height:35px;">
										<div style="float:left; width:85px;">Jam Pulang</div>
										<div style="float:left; width:10px;">:</div>
										<span><div style="display:table;"><input type='text' class='form-control' name='jam_pulang'></div></span>
								</div>
								<div style="clear:both;line-height:35px;">
