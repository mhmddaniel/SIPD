							...
							<div class="col-lg-6">
								<div class="panel panel-success">
									<div class="panel-heading">
										<div class="row">
												<div class="col-lg-6"><i class="fa fa-star fa-fw"></i> <b>FORM EDIT HARI KERJA</b></div>
												<div class="col-lg-6">
...
<form id="content-form" method="post" action="<?=site_url("appbina/harian/jadual_harian_edit_aksi");?>" enctype="multipart/form-data" role="form">
<div class="row">
	<div class="col-lg-12">
								<div style="line-height:35px;">
										...
										<input type='hidden' name='tanggal_harian' value='<?=$val->tanggal_harian;?>'>
										<input type='text' class='form-control' name='tttt' value='<?=$val->tanggal_harian;?>' disabled>
										</div></span>
								</div>
								<div style="clear:both;line-height:35px;">
										<div style="float:left; width:85px;">Keterangan</div>
										<div style="float:left; width:10px;">:</div>
										<span><div style="display:table;"><input type='text' class='form-control' name='keterangan' value='<?=$val->keterangan;?>'></div></span>
								</div>
	</div>
	<!-- /.col-lg-12 -->
</div>
