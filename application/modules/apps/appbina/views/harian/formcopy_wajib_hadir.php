							...
							<div class="col-lg-12">
								<div class="panel panel-success">
									<div class="panel-heading">
										<div class="row">
												<div class="col-lg-6"><i class="fa fa-copy fa-fw"></i> <b>FORM COPY WAJIB HADIR</b></div>
												<div class="col-lg-6">
...
<div class="row">
	...
	<div class="panel panel-warning" id="panel_utama">
		<div class="panel-heading">
				<div class="row">
					<div class="col-lg-6">
			<i class="fa fa-user fa-fw"></i> Pilih Hari Kerja
					</div>
					<div class="col-lg-6">
...
<th style="width:160px;text-align:center; vertical-align:middle">WAJIB HADIR</th>
</tr>
</thead>
<tbody id=list>
</tbody>
...
var bulan = $("#bulan_act").html();
	$.ajax({
		type:"POST",
		url:"<?=site_url();?>appbina/harian/getcopy",
	...
	//tombol aksi<--
					...
					table = table+ "<td style='padding:3px;'>" +item.wajib_hadir+" pegawai</td>";
					table = table+ "</tr>";
					no++;
				}); //endeach
					$('#list').html(table);
...
function pilih(idd){
	$.ajax({
		type:"POST",
		url:"<?=site_url();?>appbina/harian/copy_wajib_hadir_aksi",
		data:{"idd": idd},
		beforeSend:function(){	
			$('#list').html('<tr><td colspan=6><p class="text-center"><i class="fa fa-spinner fa-spin fa-5x"></i><p></td></tr>');
			$('#paging').html('');
