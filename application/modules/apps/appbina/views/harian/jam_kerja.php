<div class="row">
	<div class="col-lg-12">
		<h3 class="page-header" style="padding-bottom:10px;">Jam Kerja</h3>
	</div>
	<!-- /.col-lg-12 -->
</div>
							...
							<div class="col-lg-12">
								<div class="panel panel-default">
									<div class="panel-heading">
											<div class="dropdown"><button class="btn btn-default dropdown-toggle btn-xs" type="button" id="ddMenuT" data-toggle="dropdown"><span class="fa fa-clock-o fa-fw"></span></button>
												<ul class="dropdown-menu" role="menu" aria-labelledby="ddMenuT">
													<li role="presentation" onclick="ppost('xx','formtambah_jam_kerja');"><a href="#" role="menuitem" tabindex="-1" style="cursor:pointer;"><i class="fa fa-binoculars fa-fw"></i> Tambah Jam Kerja</a></li>
												</ul>
												<b>DAFTAR JAM KERJA</b>
											</div>
									</div>
...
<th style="width:50px;text-align:center; vertical-align:middle">JAM MASUK</th>
<th style="width:50px;text-align:center; vertical-align:middle">JAM PULANG</th>
...
var batas = $('#item_length').val();
	$.ajax({
		type:"POST",
		url:"<?=site_url();?>appbina/harian/getjam_kerja",
		...
		success:function(data){
			if((data.hslquery.length)>0){
				...
				$.each( data.hslquery, function(index, item){
					table = table+ "<tr id='row_"+item.id_jam+"' style='height:35px;'>";
	...
	//tombol aksi-->
					table = table+ "<td valign=top style='padding:3px 0px 0px 0px;' align=center>";
						...
						table = table+ '<li role="presentation"><a role="menuitem" tabindex="-1" style="cursor:pointer;" onClick="ppost('+item.id_jam+',\'formedit_jam_kerja\');"><i class="fa fa-pencil fa-fw"></i> Edit Data</a></li>';
						if(item.hapus=="ya"){
						table = table+ '<li role="presentation"><a role="menuitem" tabindex="-1" style="cursor:pointer;" onClick="ppost('+item.id_jam+',\'formhapus_jam_kerja\');"><i class="fa fa-trash fa-fw"></i> Hapus Data</a></li>';
						}
						table = table+ "</ul>";
						table = table+ "</div>";
					table = table+ "</td>";
	//tombol aksi<--
					table = table+ "<td style='padding:3px;'>"+item.jam_masuk+"</td>";
					table = table+ "<td style='padding:3px;'>" +item.jam_pulang+"</td>";
...
function ppost(idd,act){
	...
	$('#sb_act').attr('action','<?=site_url();?>module/appbina/harian/'+act);
