							...
							<div class="col-lg-6">
								<div class="panel panel-success">
									<div class="panel-heading">
										<div class="row">
												<div class="col-lg-6"><i class="fa fa-star fa-fw"></i> <b>FORM TAMBAH LOKASI APEL</b></div>
												<div class="col-lg-6">
...
<form id="content-form" method="post" action="<?=site_url("appbina/apel/lokasi_tambah_aksi");?>" enctype="multipart/form-data" role="form">
<div class="row">
	<div class="col-lg-12">
								<div style="line-height:35px;">
										<div style="float:left; width:85px;">Kode lokasi</div>
										<div style="float:left; width:10px;">:</div>
										<span><div style="display:table;"><input type='text' class='form-control' name='kode_lokasi'></div></span>
								</div>
								<div style="clear:both;line-height:35px;">
										<div style="float:left; width:85px;">Lokasi</div>
										<div style="float:left; width:10px;">:</div>
										<span><div style="display:table;"><input type='text' class='form-control' name='lokasi'></div></span>
								</div>
								<div style="clear:both;line-height:35px;">
