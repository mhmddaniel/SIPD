							...
							<div class="col-lg-12">
								<div class="panel panel-success">
									<div class="panel-heading">
										<div class="row">
												<div class="col-lg-6"><i class="fa fa-sort-amount-desc fa-fw"></i> <b>FORM TAMBAH WAJIB APEL</b></div>
												<div class="col-lg-6">
...
<form id="content-form" method="post" action="<?=site_url("appbina/apel/wajib_apel_tambah_aksi");?>" enctype="multipart/form-data" role="form">
<input type="hidden" name="tanggal_apel" value="<?=$val->tg_apel;?>">
<div class="row">
	<div class="col-lg-6">
			...
			<div class="panel-body" style="padding-top:5px; padding-bottom:5px;">
								...
								<div style="clear:both;line-height:30px;">
										...
										<span><div style="display:table;">
													<select id="lokasi_apel" name="lokasi_apel" class="form-control">
														<?php
															foreach($lokasi_apel as $key=>$val){
																$selLokasi = ($lokasi==$key)?"selected":"";
																echo '<option value="'.$key.'" '.$selLokasi.'>'.$val.'</option>';															
															}
														?>
													</select>
										</div></span>
...
var jenjang = $('#a_jenjang').val();
	$.ajax({
		type:"POST",
		url:"<?=site_url();?>appbina/apel/getbelum",
...
function simpan(){
	var data="";
	var dati="";
			var lksi = $.trim($("#lokasi_apel").val());
			data=data+""+lksi+"**";
			if( lksi =="0"){	dati=dati+"LOKASI APEL tidak boleh kosong\n";	}
