...
function gridpagingA(hal){
	...
	$.ajax({
		type:"POST",
		url:"<?=site_url();?>appbina/cuti/getdata1",
		...
		success:function(data){
			if((data.hslquery.length)>0){
				...
				if((data.hslquery.length)!=null){
					if((data.hslquery.length)>0){
						document.getElementById("notif1").innerHTML = "+ " +(data.hslquery.length);
				...
				if((data.hslquery3.length)!=null){
					if((data.hslquery3.length)>0){
						document.getElementById("notif2").innerHTML = "+ " +(data.hslquery3.length);
					} else{
					...
					/* if((data.hslquery2.length)>0 || (data.hslquery3.length)>0){
					document.getElementById("notif").innerHTML = "+ " +(data.hslquery2.length + data.hslquery3.length);
					document.getElementById("notif1").innerHTML = "+ " +(data.hslquery2.length);
					document.getElementById("notif2").innerHTML = "+ " +(data.hslquery3.length);
					}
