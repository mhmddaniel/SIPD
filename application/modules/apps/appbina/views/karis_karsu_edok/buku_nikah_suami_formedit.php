<form role="form" id="form_buku_nikah_suami" action="<?=site_url();?>appbina/karis_karsu_edok/buku_nikah_suami_edit_aksi">
<div class="panel panel-info">
	<div class="panel-heading">
		<i class="fa fa-edit fa-fw"></i> <b>Form Buku Nikah Suami</b>
	...
	<div class="panel-body">
		...
		<div class="row" style="padding-top:15px;">
			<div class="col-lg-6">
			        <button type="submit" class="btn btn-primary" onclick="simpan_suami();return false;"><i class="fa fa-save fa-fw"></i> Simpan</button>
...
function simpan_suami(){
		var dati="";
				...
				if( lksk ==""){	dati=dati+"NOMOR BUKU NIKAH tidak boleh kosong\n";	}
				if( tgll ==""){	dati=dati+"TANGGAL BUKU NIKAH tidak boleh kosong\n";	}
		if( dati !=""){
			alert(dati);
			return false;
		} else { simpan();	}
