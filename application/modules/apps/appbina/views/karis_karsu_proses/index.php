...
function gridpagingA(hal){
	...
	//tombol aksi-->
					table = table+ "<td valign=top style='padding:3px 0px 0px 0px;' align=center>";
						...
						table = table+ '<li role="presentation"><a role="menuitem" tabindex="-1" style="cursor:pointer;" onClick="ppost('+item.id_ibel+',\'ibel_injek/edit\');"><i class="fa fa-pencil fa-fw"></i> Edit Data</a></li>';
						if(accIb.thumb=="assets/file/foto/photo.jpg"){
						table = table+ '<li role="presentation"><a role="menuitem" tabindex="-1" style="cursor:pointer;" onclick="ppost('+item.id_ibel+',\'ibel_injek/hapus\');"><i class="fa fa-trash fa-fw"></i> Hapus Data</a></li>';
						}
						table = table+ "</ul>";
						table = table+ "</div>";
						} else {
						table = table+ '<div class="btn btn-default btn-xs" onClick="ppost('+item.id_karis_karsu+',\'karis_karsu_proses/alih\');"><i class="fa fa-binoculars fa-fw"></i></div>';
						}
					table = table+ "</td>";
	//tombol aksi<--
					table = table+ "<td><div>";
					...
					table = table+ "<div style='float:left; width:10px;'>:</div>";
					table = table+ "<div style='float:left;'>"+item.pendidikan_suris+"</div>";
					table = table+ "</div>";
					table = table+ "<div style='clear:both'>";
					...
					table = table+ '<a href="#" class="label label-info" onclick="ppost('+item.id_karis_karsu+',\'karis_karsu_proses/upl\'); return false;"><i class="fa fa-upload fa-fw"></i> Atur Dokumen</a><br/>';
										}
										if(accIb.thumb!="assets/file/foto/photo.jpg"){
					...
					table = table+ "</div>";
									...
									table = table+ "<div>";
									table = table+ "<div style='float:left; width:135px;'>Nomor Karis/Karsu</div>";
									table = table+ "<div style='float:left; width:10px;'>:</div>";
...
function ppost(idd,act){
	...
	var tab = tab + '<input type="hidden" name="asal" value="appbina/karis_karsu_proses">';
