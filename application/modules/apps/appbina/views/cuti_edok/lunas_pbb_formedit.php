<form role="form" id="form_lunas_pbb" action="<?=site_url();?>appbina/cuti_edok/lunas_pbb_edit_aksi">
<div class="panel panel-info">
	<div class="panel-heading">
		<i class="fa fa-edit fa-fw"></i> <b>Form Bukti Lunas PBB</b>
	...
	<div class="panel-body">
		...
		<div class="row" style="padding-top:15px;">
			<div class="col-lg-6">
			        <button type="submit" class="btn btn-primary" onclick="simpan_lunas_pbb();return false;"><i class="fa fa-save fa-fw"></i> Simpan</button>
...
function simpan_lunas_pbb(){
		var dati="";
				...
				if( lksk ==""){	dati=dati+"NOMOR lunas_pbb tidak boleh kosong\n";	}
				if( tgll ==""){	dati=dati+"TANGGAL lunas_pbb tidak boleh kosong\n";	}
		if( dati !=""){
			alert(dati);
			return false;
		} else { simpan();	}
