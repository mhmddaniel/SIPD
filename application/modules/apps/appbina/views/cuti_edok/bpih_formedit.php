<form role="form" id="form_bpih" action="<?=site_url();?>appbina/cuti_edok/bpih_edit_aksi">
<div class="panel panel-info">
	<div class="panel-heading">
		<i class="fa fa-edit fa-fw"></i> <b>Form Bukti Setoran BPIH</b>
	...
	<div class="panel-body">
		...
		<div class="row" style="padding-top:15px;">
			<div class="col-lg-6">
			        <button type="submit" class="btn btn-primary" onclick="simpan_bpih();return false;"><i class="fa fa-save fa-fw"></i> Simpan</button>
...
function simpan_bpih(){
		var dati="";
				...
				if( lksk ==""){	dati=dati+"NOMOR BPIH tidak boleh kosong\n";	}
				if( tgll ==""){	dati=dati+"TANGGAL BPIH tidak boleh kosong\n";	}
		if( dati !=""){
			alert(dati);
			return false;
		} else { simpan();	}
