...
?>
<form role="form" id="form_keterangan_dokter" action="<?=site_url();?>appbina/cuti_edok/keterangan_dokter_edit_aksi">
<div class="panel panel-info">
	<div class="panel-heading">
		<i class="fa fa-edit fa-fw"></i> <b>Form Surat Keterangan Dokter</b>
