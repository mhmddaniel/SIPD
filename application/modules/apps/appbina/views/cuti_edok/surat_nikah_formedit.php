<form role="form" id="form_surat_nikah" action="<?=site_url();?>appbina/cuti_edok/surat_nikah_edit_aksi">
<div class="panel panel-info">
	<div class="panel-heading">
		<i class="fa fa-edit fa-fw"></i> <b>Form Bukti Lunas surat_nikah</b>
	...
	<div class="panel-body">
		...
		<div class="row" style="padding-top:15px;">
			<div class="col-lg-6">
			        <button type="submit" class="btn btn-primary" onclick="simpan_surat_nikah();return false;"><i class="fa fa-save fa-fw"></i> Simpan</button>
...
function simpan_surat_nikah(){
		var dati="";
				...
				if( lksk ==""){	dati=dati+"NOMOR surat_nikah tidak boleh kosong\n";	}
				if( tgll ==""){	dati=dati+"TANGGAL surat_nikah tidak boleh kosong\n";	}
		if( dati !=""){
			alert(dati);
			return false;
		} else { simpan();	}
