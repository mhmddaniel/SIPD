<form role="form" id="form_ktp_istri" action="<?=site_url();?>appbina/cuti_edok/ktp_istri_edit_aksi">
<div class="panel panel-info">
	<div class="panel-heading">
		<i class="fa fa-edit fa-fw"></i> <b>Form Bukti Lunas ktp_istri</b>
	...
	<div class="panel-body">
		...
		<div class="row" style="padding-top:15px;">
			<div class="col-lg-6">
			        <button type="submit" class="btn btn-primary" onclick="simpan_ktp_istri();return false;"><i class="fa fa-save fa-fw"></i> Simpan</button>
...
function simpan_ktp_istri(){
		var dati="";
				...
				if( lksk ==""){	dati=dati+"NOMOR ktp_istri tidak boleh kosong\n";	}
				if( tgll ==""){	dati=dati+"TANGGAL ktp_istri tidak boleh kosong\n";	}
		if( dati !=""){
			alert(dati);
			return false;
		} else { simpan();	}
