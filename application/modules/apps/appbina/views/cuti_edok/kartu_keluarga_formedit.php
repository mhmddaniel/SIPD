<form role="form" id="form_kartu_keluarga" action="<?=site_url();?>appbina/cuti_edok/kartu_keluarga_edit_aksi">
<div class="panel panel-info">
	<div class="panel-heading">
		<i class="fa fa-edit fa-fw"></i> <b>Form kartu_keluarga</b>
	...
	<div class="panel-body">
		...
		<div class="row" style="padding-top:15px;">
			<div class="col-lg-6">
			        <button type="submit" class="btn btn-primary" onclick="simpan_kartu_keluarga();return false;"><i class="fa fa-save fa-fw"></i> Simpan</button>
