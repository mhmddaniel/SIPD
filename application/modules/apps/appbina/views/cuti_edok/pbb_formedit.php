<form role="form" id="form_pbb" action="<?=site_url();?>appbina/cuti_edok/pbb_edit_aksi">
<div class="panel panel-info">
	...
	<div class="panel-body">
		...
		<div class="row" style="padding-top:15px;">
			<div class="col-lg-6">
			        <button type="submit" class="btn btn-primary" onclick="simpan_pbb();return false;"><i class="fa fa-save fa-fw"></i> Simpan</button>
...
function simpan_pbb(){
		var dati="";
				...
				if( lksk ==""){	dati=dati+"NOMOR pbb tidak boleh kosong\n";	}
				if( tgll ==""){	dati=dati+"TANGGAL pbb tidak boleh kosong\n";	}
		if( dati !=""){
			alert(dati);
			return false;
		} else { simpan();	}
