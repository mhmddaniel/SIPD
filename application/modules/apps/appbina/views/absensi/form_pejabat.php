...
<div class="row" style="margin-bottom:5px">
	<div class="col-lg-12">
		<span class="btn btn-primary btn-xs" style="width:220px; text-align:center; cursor:default;"><?=$hari;?></span>
	</div><!-- /.col-lg-12 -->
</div><!-- /.row -->

<div class="row" style="margin-bottom:5px">
	<div class="col-lg-12">
		 <div class="btn btn-primary btn-lg" style="width:110px; text-align:right; cursor:default;" id="output"><?=$jam;?></div>
...
function kirim(token){
		$.ajax({
			type:"POST",
			url:"<?=site_url();?>appbina/token/input_masuk_pejabat",
			data:{"token": token },
			beforeSend:function(){
