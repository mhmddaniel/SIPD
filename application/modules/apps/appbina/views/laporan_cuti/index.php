            			...
            			<div class="col-lg-12">
            				<div class="panel panel-green">
            					<div class="panel-heading">
            						<div class="row">
            							<div class="col-lg-12">
            								<i class="fa fa-calendar fa-2x fa-fw"></i>  <span style="font-size:24px;">LAPORAN PENGAJUAN CUTI</span>
            							</div>
            						</div>
            					</div>
            								...
            								if($bup!=""){
            									foreach($bup AS $key=>$val){
            										...
            										<tr>
            											...
            											<td>
            												<center>
            													<div class="btn btn-default btn-sm" onClick=""><?=$val->cuti_sakit;?></div>

            												</center>
            											</td>
            											<td>
            												<center>
            													<div class="btn btn-default btn-sm" onClick=""><?=$val->cuti_besar?></div>
            												</center>
            											</td>
            											<td>
            												<center>
            													<div class="btn btn-default btn-sm" onClick=""> <?=$val->cuti_besar_haji?></div>
            												</center>
            											</td>
            											<td>
            												<center>
            													<div class="btn btn-default btn-sm" onClick=""> <?=$val->cuti_besar_umroh?></div>
            												</center>
            											</td>
            											<td>
            												<center>
            													<div class="btn btn-default btn-sm" onClick=""> <?=$val->cuti_alasan_penting?></div>
            												</center>
            											</td>
            											<td>
            												<center>
            													<div class="btn btn-default btn-sm" onClick=""> <?=$val->cuti_bersalin?></div>
            												</center>
            											</td>
            											<td>
            												<center>
            													<div class="btn btn-default btn-sm" onClick=""> <?=$val->cuti_tahunan?></div>
            												</center>
            											</td>
            											<td>
            												<center>
            													<div class="btn btn-default btn-sm" onClick=""> <?=$val->cuti_diluar_tanggungan_negara?></div>
            												</center>
            											</td>
            											<td>
            												<center>
            												<div class="btn btn-danger btn-sm" onClick="">T: <?=($val->cuti_sakit+$val->cuti_besar+$val->cuti_besar_haji+$val->cuti_besar_umroh+$val->cuti_alasan_penting+$val->cuti_bersalin+$val->cuti_tahunan+$val->cuti_diluar_tanggungan_negara);?></div>
            												</center>
            											</td>
