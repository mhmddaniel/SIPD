...
function gridpagingA(hal){
	...
	//tombol aksi-->
					table = table+ "<td valign=top style='padding:3px 0px 0px 0px;' align=center>";
						...
						table = table+ '<div class="btn btn-default btn-xs" onClick="ppost('+item.id_karpeg+',\'karpeg_proses/alih\');"><i class="fa fa-binoculars fa-fw"></i></div>';
						}
					table = table+ "</td>";
	//tombol aksi<--
					table = table+ "<td><div>";
					...
					table = table+ '<a href="#" class="label label-info" onclick="ppost('+item.id_karpeg+',\'karpeg_proses/upl\'); return false;"><i class="fa fa-upload fa-fw"></i> Atur Dokumen</a><br/>';
										}
										if(accIb.thumb!="assets/file/foto/photo.jpg"){
...
function ppost(idd,act){
	...
	var tab = tab + '<input type="hidden" name="asal" value="appbina/karpeg_proses">';
