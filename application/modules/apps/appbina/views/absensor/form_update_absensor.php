<table>
	<tr>
		<td style="width:150px;">Nama petugas</td>
	...
	<tr>
		...
		<td>:</td>
		<td>
		<?=form_input('username',(!isset($pengelola->username))?'':$pengelola->username,'class="form-control" style="padding-left:2px; padding-right:2px;" placeholder="Tanpa spasi"');?>
		</td>
	</tr>
</table>