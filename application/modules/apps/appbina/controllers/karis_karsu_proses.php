...
class Karis_karsu_proses extends MX_Controller {
...
///////////////////////////////////////////////////////////////////////////////////
	function index(){
		...
		$data['stib'] = Modules::run("appbina/karis_karsu_daftar/tahapan_karis_karsu");
		...
		$this->load->view('karis_karsu_proses/'.$rd,$data);
	}
	function alih(){
		...
		$ibel = $this->m_karis_karsu->ini_karis_karsu($_POST['idd']);
		if($ibel->status=="aju"){	$this->m_karis_karsu->koreksi_pemohon($_POST['idd']);	}

		redirect("module/appbina/karis_karsu_proses/ini");
	}
	function ini(){
		$data['satu'] = "Pengajuan Karis/Karsu";
		...
		$this->load->view('karis_karsu_proses/ini',$data);
	}
	function catatan(){
		$idd = $this->session->userdata('idd');
		$data['ibel'] = $this->m_karis_karsu->ini_karis_karsu($idd);
		$data['catatan'] = $this->m_karis_karsu->get_catatan($idd);
		$this->load->view('karis_karsu_proses/catatan',$data);
	}
	function ini_catatan(){
		$catatan = $this->m_karis_karsu->ini_catatan($_POST['id_catatan']);
		echo json_encode($catatan);
	}
	function save_catatan(){
		$idd = $this->session->userdata('idd');
		$this->m_karis_karsu->save_catatan($idd,$_POST);
		echo "sukses";
	}
	function save_jawaban(){
		$this->m_karis_karsu->save_jawaban($_POST);
		echo "sukses";
	}
	function hapus_catatan(){
		$this->m_karis_karsu->hapus_catatan($_POST);
		echo "sukses";
	}
	function jawaban(){
		$idd = $this->session->userdata('idd');
		$data['ibel'] = $this->m_karis_karsu->ini_karis_karsu($idd);
		$data['catatan'] = $this->m_karis_karsu->get_catatan($idd);
		$this->load->view('karis_karsu_proses/jawaban',$data);
	}
	function ajukan(){
		$data['idd'] = $this->session->userdata('idd');
		...
		$this->load->view('karis_karsu_proses/acc',$data);
	}
	function edit_surat(){
		$data['idd'] = $this->session->userdata('idd');
		$data['isi'] = $this->m_karis_karsu->ini_karis_karsu($data['idd']);
		$this->load->view('karis_karsu_proses/edit_surat',$data);
	}
	function edit_surat_aksi(){
		$this->m_karis_karsu->edit_surat($_POST);
		echo "sukses";
	}
	function acc_aksi(){
		$this->m_karis_karsu->acc_pemohon($_POST);
		echo "sukses";
	}
	function not_ajukan(){
		$data['idd'] = $this->session->userdata('idd');
		...
		$data['buku_nikah_istri'] = $this->m_karis_karsu->cek_dokumen($data['idd'],'buku_nikah_istri');
		$data['catatan'] = $this->m_karis_karsu->get_catatan($data['idd'],'ditanya');
		$this->load->view('karis_karsu_proses/btl',$data);
	}
	function btl_aksi(){
		$this->m_karis_karsu->btl_pemohon($_POST);
		echo "sukses";
	}
	...
	function upl(){
		...
		$this->session->set_userdata('idd',$_POST['idd']);
		$data['idd'] = $this->session->userdata('idd');
		$data['satu'] = "eDokumen Karis/Karsu";
		...
		$data['idd'] = $this->session->userdata('idd');
			...
			$dWpangkat = $this->dropdowns->kode_pangkat();
			$dWgolongan = $this->dropdowns->kode_golongan();
//		$data['acc'] = $this->m_karis_karsu->ini_acc($data['idd']);
		$data['val'] = $this->m_karis_karsu->ini_karis_karsu($data['idd']);
		$data['val']->nama_pangkat = @$dWpangkat[$val->kode_golongan];
		$data['val']->nama_golongan = @$dWgolongan[$val->kode_golongan];
		$data['id_pegawai'] = $data['val']->id_pegawai;
		$data['kode_dokumen'] = Modules::run("appbina/karis_karsu_daftar/kode_dokumen_karis_karsu");
		$this->load->view('karis_karsu_proses/upl',$data);
	}
	function uploadDok(){
		$data['id_pegawai'] = $_POST['id_pegawai'];
		$data['idd'] = $this->session->userdata('idd');
		$data['acc'] = $this->m_karis_karsu->ini_karis_karsu($data['idd']);
		$data['komponen'] = $_POST['komponen'];
		$data['isi'] = $this->m_karis_karsu->ini_karis_karsu($data['idd']);
		$data['row'] = $this->m_edok->cek_dokumen($_POST['id_pegawai'],$_POST['komponen'],$data['acc']->id_peg_perkawinan);
		$this->load->view('karis_karsu_proses/upload',$data);
	}
