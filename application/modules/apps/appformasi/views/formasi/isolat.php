		...
		<div class="panel-heading">
									<div class="dropdown"><button class="btn btn-primary dropdown-toggle btn-xs" type="button" id="ddMenuT" data-toggle="dropdown"><span class="fa fa-sitemap fa-fw"></span></button>
										<ul class="dropdown-menu" role="menu" aria-labelledby="ddMenuT">
											<li role="presentation"><a href="<?=site_url('module/appformasi/formasi');?>" role="menuitem" tabindex="-1" style="cursor:pointer;"><i class="fa fa-list fa-fw"></i> Generatif Unit Kerja</a></li>
											<li role="presentation"><a role="menuitem" tabindex="-1" style="cursor:pointer;"><i class="fa fa-sitemap fa-fw"></i> Isolat Unit Kerja</a></li>
										</ul>
										Isolat Unit Kerja
									</div>
		</div>
...
var tanggal = "01-"+bulan+"-"+tahun;
			$.ajax({
				type:"POST",
				url:"<?=site_url();?>appformasi/formasi/gettreeisolat/",
...
////////////////tombol treegrid && variabel kunci-->
				...
				table = table+ "</td>";
////////////////tombol treegrid && variabel kunci<--
				table = table+ "<td align=left style='padding:3px;'>js: <b></b><br>jfu: <b></b><br>jft: <b></b><br>guru: <b></b></td>";
