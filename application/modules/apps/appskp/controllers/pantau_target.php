...
class Pantau_target extends MX_Controller {
...
/////////////////////////////////////////////////////////////////////////////
	function index(){
		$tgHl = (isset($_POST['tahun']))?$_POST['tahun']."-01-01":date('Y-m-d');
		...
		$data['st_realisasi'] = $this->dropdowns->tahapan_realisasi();
		...
		$this->load->view('pantau_target/index',$data);
	}
...
//				$data['hslquery'][$key]->nomenklatur_jabatan = (@$val->jab_type=='jft-guru')?@$dWjjGuru[$val->kode_golongan]." - ".$val->nomenklatur_jabatan:$val->nomenklatur_jabatan;
				...
				$data['hslquery'][$key]->realisasi = $this->m_pantau->get_realisasi_peg_tahun($val->id_pegawai,$tahun);
			}
