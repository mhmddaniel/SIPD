...
<table width="100%" class="table table-striped table-bordered table-hover" style="margin-bottom:5px;">
<thead id=gridhead>
<tr height=20>
<th width=65>No.</th>
<th width=25>AKSI</th>
<th width=200>TAHUN / PERIODE / STATUS</th>
<th align=center>PEJABAT PENILAI</th>
<th width=360 align=center>PEGAWAI</th>
</tr>
</thead>
<tbody id=list>
...
var batas = $('#item_length').val();
			$.ajax({
				type:"POST",
				url:"<?=site_url();?>appskp/realisasi_verifikasi/getdata/",
...
function pindah(){
			$.ajax({
				type:"POST",
				url:"<?=site_url();?>appskp/realisasi_verifikasi/target/",
