                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h4 class="modal-title" id="myModalLabel">FORM TAMBAH <?=strtoupper($tipe);?></h4>
                                        </div>
  ...
  <div class="row">
    ...
    <form id="content-form" method="post" action="<?=site_url("appskp/tupoksi/tambah_aksi");?>" enctype="multipart/form-data">
    <table width="100%" cellspacing="0" cellpadding="0" class="table-form-flat">
        ...
        <tr>
          ...
          <td colspan="3">
		  <textarea rows="4"  style="width:600px;" name="isi_tupoksi" id="isi_tupoksi"></textarea>
