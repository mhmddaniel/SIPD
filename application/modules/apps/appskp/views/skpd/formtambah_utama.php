                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h4 class="modal-title" id="myModalLabel">FORM TAMBAH MASTER SKPD</h4>
                                        </div>
  ...
  <div class="row">
    ...
    <form id="content-form" method="post" action="<?=site_url("appskp/skpd/tambahutama_aksi");?>" enctype="multipart/form-data">
    <table width="100%" cellspacing="0" cellpadding="0" class="table-form-flat">
        <tr>
          <td width="20%">Nama Unor</td>
          <td colspan="3">
		  <input type="text" id="nama_unor" name="nama_unor" size="70">
		  </td>
        </tr>
        <tr>
          <td width="20%">Jenis Unor</td>
          <td colspan="3">
		  <input type="text" id="jenis" name="jenis" size="70">
		  </td>
        </tr>
        ...
        <tr>
          ...
          <td colspan="3">
		  <input type="text" id="nomenklatur_jabatan" name="nomenklatur_jabatan" size="70">
		  </td>
        </tr>
        <tr>
          <td width="20%">pada</td>
          <td colspan="3">
		  <input type="text" id="nomenklatur_pada" name="nomenklatur_pada" size="70">
		  </td>
        </tr>
        <tr>
          <td width="20%">Index Pencarian</td>
          <td colspan="3">
		  <input type="text" id="nomenklatur_cari" name="nomenklatur_cari" size="70">
		  </td>
        </tr>
        <tr>
          <td>Eselon</td>
        ...
        <tr>
          <td>Kode Unor</td>
          <td colspan="3">
		  <input type="text" id="kode_unor" name="kode_unor" size="70">
		  </td>
        </tr>
      </table>
