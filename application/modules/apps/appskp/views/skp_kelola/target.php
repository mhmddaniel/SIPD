...
function setForm(tujuan,idd,no){
	...
	kop['form_acc'] = "FORM PERSETUJUAN TARGET SKP"; 
	kop['tambah_catatan'] = "FORM TAMBAH CATATAN"; 
	kop['edit_catatan'] = "FORM EDIT CATATAN"; 
	kop['hapus_catatan'] = "FORM HAPUS CATATAN"; 
	var act = []; 
	act['form_kembalikan'] = "<?=site_url();?>appskp/skp_kelola/kembali_aksi"; 
	act['form_acc'] = "<?=site_url();?>appskp/skp_kelola/acc_penilai_aksi"; 
	act['tambah_catatan'] = "<?=site_url();?>appskp/skp_kelola/tambah_catatan_aksi"; 
	act['edit_catatan'] = "<?=site_url();?>appskp/skp_kelola/edit_catatan_aksi"; 
	act['hapus_catatan'] = "<?=site_url();?>appskp/skp_kelola/hapus_catatan_aksi"; 
	var btt = []; 
	...
	btt['hapus_catatan'] = "<button id='btAct' type=sumbit class='btn btn-danger' onclick='ajukan(); return false;'><i class='fa fa-save fa-fw'></i> Hapus</button>"; 
			$.ajax({
			type:"POST",
...
<div class="row">
	<div class="col-lg-12" style="padding-bottom:5px; text-align:right">
		 <a href="<?=site_url('module/appskp/skp_kelola');?>"><button class="btn btn-primary" type="button"><i class="fa fa-fast-backward fa-fw"></i>Kembali...</button></a>
	</div>
	<!-- /.col-lg-12 -->
</div>
<!-- /.row -->
<div class="row">
	...
	<div class="dropdown"><button class="btn btn-primary dropdown-toggle btn-xs" type="button" id="ddMenu1" data-toggle="dropdown"><span class="fa fa-tasks fa-fw"></span></button>
		<ul class="dropdown-menu" role="menu" aria-labelledby="ddMenu1">
			...
			<li role="presentation"><a role="menuitem" tabindex="-1" style="cursor:pointer;" onClick="setForm('form_acc','1','1');"><i class="fa fa-upload fa-fw"></i>Disetujui</a></li>
		</ul>
	</div>
	</div>
