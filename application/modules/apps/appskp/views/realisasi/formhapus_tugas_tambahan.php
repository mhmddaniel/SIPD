...
<tr id='row_tt' class=warning>
	...
	<td colspan=8>		<?=form_hidden('idd',$idd);?>
		<div style="clear:both;">
		<button class="btn simpan_xx btn-primary btn-xs" type="button" id="<?=(!isset($idd))?'xx':$idd;?>" data-nomor="<?=$nomor;?>" data-lembar="tugas_tambahan" data-aksi="<?=site_url('appskp/realisasi/tugas_tambahan_hapus_aksi');?>"><i class="fa fa-save"></i> Hapus</button>
		<button class="btn batal btn-primary btn-xs" type="button" id="<?=(!isset($idd))?'xx':'tugas_tambahan_'.$idd;?>" data-nomor="<?=$nomor;?>"><i class="fa fa-close"></i> Batal...</button>
		</div>
	</td>
</tr>
