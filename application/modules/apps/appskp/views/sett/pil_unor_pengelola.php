...
<th style="width:150px;text-align:center; vertical-align:middle">MASA BERLAKU</th>
</tr>
</thead>
			...
			if((data.hslquery.length)>0){
				...
				var no=data.mulai;
					$.each( data.hslquery, function(index, item){
						...
						table = table+ "<td onclick='pilih_satu("+item.id_unor+");'>"+item.tmt_berlaku+"<br/><u>s.d.</u><br/>"+item.tst_berlaku+"</td>";
						table = table+ "</tr>";
						no++;
					}); //endeach
