...
<form id="pw-form" method="post" action="<?=site_url('appskp/sett/aktifkan_aksi');?>" enctype="multipart/form-data">
<table width="100%">
<tr>
<td colspan=2>&nbsp;</td>
...
<button class="btn btn-primary" style="float:right;margin-right:5px;" id="pwButtonAksi" onclick="nonaktifkan_aksi(); return false;"><i class="fa fa-bell-o fa-fw"></i> Aktfifkan</button>
</td>
</tr>
</table>
</form>
