								...
								<div class="col-lg-6">
									<div class="dropdown"><button class="btn btn-primary dropdown-toggle btn-xs" type="button" id="ddMenuT" data-toggle="dropdown"><span class="fa fa-indent fa-fw"></span></button>
										<ul class="dropdown-menu" role="menu" aria-labelledby="ddMenuT">
											<li role="presentation"><a href="<?=site_url('module/appskp/sett/pantau_target_umpeg');?>" role="menuitem" tabindex="-1" style="cursor:pointer;"><i class="fa fa-list-ol fa-fw"></i> Menyusun Target Kinerja</a></li>
...
var kode_unor = $('#kode_unor').val();
			$.ajax({
				type:"POST",
				url:"<?=site_url();?>appskp/sett/get_pantau_realisasi_umpeg/",
