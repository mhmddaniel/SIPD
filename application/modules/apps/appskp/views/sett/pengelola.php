								...
								<div class="col-lg-6">
									<div class="dropdown"><button class="btn btn-primary dropdown-toggle btn-xs" type="button" id="ddMenuT" data-toggle="dropdown"><span class="fa fa-tags fa-fw"></span></button>
										<ul class="dropdown-menu" role="menu" aria-labelledby="ddMenuT">
											...
											<li role="presentation"><a href="<?=site_url('module/appskp/sett/pegawai_skp');?>" role="menuitem" tabindex="-1" style="cursor:pointer;"><i class="fa fa-user fa-fw"></i> Pegawai</a></li>
										</ul>
										<?=$satu;?>
									</div>
								</div>
...
<div class="btn-group pull-right">
	...
	<ul class="dropdown-menu slidedown">
		...
		<li><a href="<?=site_url('module/appskp/sett/daftar_pengelola_akses');?>" style="cursor:pointer;"><i class="fa fa-trophy fa-fw"></i> Daftar Akses Pengelola</a></li>
	</ul>
</div>
								</div>
						</div>
...
<th width=65 style="vertical-align:middle;">STATUS</th>
</tr>
</thead>
<tbody id=list>
