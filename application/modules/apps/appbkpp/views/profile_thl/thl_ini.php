	...
	<div class="col-lg-12">
     ...
     <div class="panel-body" style="padding:0px;">
		...
		<ul class="nav nav-tabs" role="tablist" id="myTab">
			<li class="dropdown"><a id='dp_pasfoto' href="#dropdown_pasfoto" role="tab" data-toggle="tab" onclick="viewTabPegawai('pasfoto','tkk');return false;"><i class="fa fa-user fa-fw"></i> Profil</a></li>
			<li class="dropdown">
			...
			<li class="dropdown"><a id='dp_sk_jabatan' href="#dropdown_sk_jabatan" role="tab" data-toggle="tab" onclick="viewTabPegawai('sk_jabatan');return false;"><i class="fa fa-tasks fa-fw"></i> Jabatan</a></li>
			<li class="dropdown"><a id='dp_spj_kegiatan' href="#dropdown_spj_kegiatan" role="tab" data-toggle="tab" onclick="viewTabPegawai('spj_kegiatan');return false;"><i class="fa fa-tasks fa-fw"></i> SPJ Kegiatan</a></li>
		...
		<div class="tab-content" style="padding:5px;">
		  ...
		  <div class="tab-pane fade" id="dropdown_spj_kegiatan">25</div>
...
function viewTabPegawai(section){
	$('#uppldok').hide();
		$.ajax({
				type:"POST",
				url:"<?=site_url();?>appbkpp/profile_thl/"+section,
				beforeSend:function(){
					$('#formedok').hide();
