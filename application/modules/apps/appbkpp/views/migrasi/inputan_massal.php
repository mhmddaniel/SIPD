<div class="row">
	<div class="col-lg-12">
		 <h3 class="page-header">Hasil Update Mutasi SOTK 2017</h3>
	</div><!-- /.col-lg-12 -->
</div><!-- /.row -->
...
<th style="width:150px;text-align:center; vertical-align:middle">eDOKUMEN</th>
</tr>
</thead>
...
function gridpaging_jabatan(hal){
	...
	$.ajax({
		type:"POST",
		url:"<?=site_url();?>appbkpp/migrasi/getdata_jabatan_uid",
		data:{"bulan":1,"tahun":2017,"hal": hal, "batas": batas,"cari":cari,"pns":pns,"kode":kode,"pkt":pkt,"jbt":jbt,"ese":ese,"tugas":tugas,"gender":gender,"agama":agama,"status":status,"jenjang":jenjang,"umur":umur,"mkcpns":mkcpns},
		beforeSend:function(){	
	...
	//tombol aksi-->
					table = table+ '<td><div class="btn btn-default btn-xs"  onclick="detil2('+item.id_pegawai+',\'appbkpp/profile/pns_ini\',\'ya\',\'sk_jabatan\');return false;"><i class="fa fa-binoculars fa-fw"></i></div></td>';
	//tombol aksi<--
