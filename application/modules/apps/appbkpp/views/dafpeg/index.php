	...
	<div class="col-lg-12">
		<div class="panel panel-default">
			<div class="panel-body" style="padding:0px;">
				<ul class="nav nav-tabs" role="tablist" id="myTab"><!-- Nav tabs -->
					<li style="padding: 7px 10px 5px 5px;">
									<div class="dropdown"><button class="btn btn-primary dropdown-toggle btn-xs" type="button" id="ddMenuT" data-toggle="dropdown"><span class="fa fa-arrows fa-fw"></span></button>
										<ul class="dropdown-menu" role="menu" aria-labelledby="ddMenuT">
											...
											<li role="presentation" class="divider utm"></li>
											...
											<li class="utm" onclick="ppost2('module/appbkpp/pegawai');"><a href='#'><i class="fa fa-arrows-alt fa-fw"></i> Daftar Master Pegawai</a></a></li>
											<li class="divider utm"></li>
											<li class="utm" onclick="ppost2('module/appbkpp/pegmasuk');"><a href='#'><i class="fa fa-sign-in fa-fw"></i> Pegawai Mutasi Masuk</a></li>
											...
											<li class="utm" onclick="ppost2('module/appbkpp/pegawai/keluar');"><a href='#'><i class="fa fa-external-link fa-fw"></i> Pegawai Mutasi Keluar</a></li>
											<li class="divider utm"></li>
											<li class="utm" onclick="ppost2('module/appbkpp/pegawai/cltn');"><a href="#"><i class="fa fa-external-link-square fa-fw"></i> Pegawai CLTN</a></li>
											<li class="utm" onclick="ppost2('module/appbkpp/pegawai/tubel');"><a href="#"><i class="fa fa-asterisk fa-fw"></i> Pegawai Tugas Belajar</a></li>
										</ul>
									</div>
					</li>
					<li class="dropdown active">
						...
						<ul class="dropdown-menu" role="menu" aria-labelledby="myTabDrop2">
							<li class="<?=($tab=="aktif")?"active":"";?>"><a href="#" tabindex="-1" role="tab" data-toggle="tab" onclick="viewTab('aktif');return false;"><i class="fa fa-user-secret fa-fw"></i> PNS dan CPNS</a></li>
							<li class="<?=($tab=="aktif_tkk")?"active":"";?>"><a href="#" role="tab" data-toggle="tab" onclick="viewTab('aktif_tkk');return false;"><i class="fa fa-credit-card fa-fw"></i> Tenaga Kerja Kontrak</a></li>
							<li class="<?=($tab=="aktif_thl")?"active":"";?>"><a href="#" role="tab" data-toggle="tab" onclick="viewTab('aktif_thl');return false;"><i class="fa fa-calendar-times-o fa-fw"></i> Tenaga Harian Lepas</a></li>
						</ul>
					</li>
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu" role="menu" aria-labelledby="myTabDrop1">
							...
							<li role="presentation" class="divider"></li>
							<li><a href="#" tabindex="-1" role="tab" data-toggle="tab" onclick="viewTab('prajab');return false;"><i class="fa fa-graduation-cap fa-fw"></i> Lulus Pra Jabatan</a></li>
							<li><a href="#" tabindex="-1" role="tab" data-toggle="tab" onclick="viewTab('diklat_penjenjangan');return false;"><i class="fa fa-graduation-cap fa-fw"></i> Lulus Diklat Penjenjangan</a></li>
							<li><a href="#" tabindex="-1" role="tab" data-toggle="tab" onclick="viewTab('diklat_fungsional');return false;"><i class="fa fa-graduation-cap fa-fw"></i> Lulus Diklat Fungsional</a></li>
							<li><a href="#" tabindex="-1" role="tab" data-toggle="tab" onclick="viewTab('diklat_teknis');return false;"><i class="fa fa-graduation-cap fa-fw"></i> Lulus Diklat Teknis</a></li>
							<li role="presentation" class="divider"></li>
				...
				<div class="isi-tab" style="display:none;" id="tab_aktif_tkk">Aktif TKK</div>
				<div class="isi-tab" style="display:none;" id="tab_aktif_thl">Aktif THL</div>
...
<!--
<a href='<?=site_url('module/appbkpp/migrasi/sisa');?>'>sisa TOTAL</a>
|| <a href='<?=site_url('module/appbkpp/migrasi/sisa/js');?>'>sisa JS</a>
|| <a href='<?=site_url('module/appbkpp/migrasi/sisa/jft');?>'>sisa JFT</a>
|| <a href='<?=site_url('module/appbkpp/migrasi/sisa/jfu');?>'>sisa JFU</a>
-->
</div><!-- /.content-wrapper -->

<!--<a href="<?=site_url('module/appbkpp/peralihan');?>">peralihan_ke_propinsi_2016</a>-->
...
function viewIni(){
	...
	var bulan = $('#bulan_act').html();
			$.ajax({
				...
				data:{"tahun": tahun,"bulan":bulan,"kode":"<?=$kode;?>","pns":"<?=$pns;?>","ppkt":"<?=$ppkt;?>","pjbt":"<?=$pjbt;?>","pese":"<?=$pese;?>","pgender":"<?=$pgender;?>","ptugas":"<?=$ptugas;?>","pjenjang":"<?=$pjenjang;?>","pstatus":"<?=$pstatus;?>","pumur":"<?=$pumur;?>","pmkcpns":"<?=$pmkcpns;?>"},
				beforeSend:function(){	
