	...
	<div class="panel panel-default" id="panel_utama">
		<div class="panel-heading">
						<div class="row"><div class="col-lg-12">
								<span><span class="btn btn-warning btn-xs" onclick="tutup();"><i class="fa fa-close fa-fw"></i></span> Daftar Pegawai Aktif</span>
...
function gridpaging_picker(hal){
	...
	//tombol aksi-->
					table = table+ "<td valign=top style='padding:3px 0px 0px 0px;' align=center>";
						table = table+ '<div class="btn btn-default btn-xs" onclick="pick_ini(\''+item.nip_baru+'\',\'<?=$idd;?>\');"><i class="fa fa-check fa-fw"></div>';
					table = table+ "</td>";
	//tombol aksi<--
