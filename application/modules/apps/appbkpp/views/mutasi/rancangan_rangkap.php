								...
								<div class="col-lg-6">
									<div class="dropdown"><button class="btn btn-primary dropdown-toggle btn-xs" type="button" id="ddMenuT" data-toggle="dropdown"><span class="fa fa-recycle fa-fw"></span></button>
										<ul class="dropdown-menu" role="menu" aria-labelledby="ddMenuT">
											<li role="presentation"><a role="menuitem" tabindex="-1" style="cursor:pointer;"><i class="fa fa-print fa-fw"></i> Cetak Daftar Jabatan Rangkap</a></li>
										</ul>
			<span style="margin-left:5px;" id=judul_skp><b>Daftar Jabatan Rangkap</b></span>
									</div>
								</div>
						</div>
		</div>
...
var status_rancangan = $('#status_rancangan').html();
	$.ajax({
		type:"POST",
		url:"<?=site_url();?>appbkpp/mutasi/getrangkap",
								...
								pemangku = pemangku+'<div style="clear:both;">';
									pemangku = pemangku+'<div>';
										pemangku = pemangku+'<div style="float:left;padding-right:5px;">';
											...
											if(status_rancangan=="Aktif"){	pemangku = pemangku+'<li role="presentation"><a role="menuitem" tabindex="-1" style="cursor:pointer;" onClick="setKembali(\'appbkpp/mutasi/kembali_jabatan_asal\',\''+item2.id_pegawai +'\',\''+item.id_unor +'\');"><i class="fa fa-fast-backward fa-fw"></i> Kembalikan ke jabatan semula</a></li>';	}
