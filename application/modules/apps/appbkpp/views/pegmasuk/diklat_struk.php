<div class="row">
	<div class="col-lg-12">
		 <h3 class="page-header">Diklat Struktural</h3>
	</div><!-- /.col-lg-12 -->
</div><!-- /.row -->
<?=$diklat;?>
<div id="komponen_temp" style="display:none;">sertifikat_diklat</div>
...
function batal_isi(){
	location.href = '<?=site_url();?>module/appbkpp/pegmasuk/diklat_struk';
}
