...
<div class="row">
	<div class="col-lg-12">
		 <h3 class="page-header">Kartu Pegawai</h3>
	</div><!-- /.col-lg-12 -->
</div><!-- /.row -->

<form role="form" id="form_master" action="<?=site_url();?>appbkpp/profile/karpeg_<?=(isset($isi->id_karpeg))?"edit":"input";?>_aksi">
<div class="row" id="content_karpeg">
<div class="col-lg-9">
	...
	<div class="panel-body">
		<div class="row">
			<div class="col-lg-4">
				...
				<input name="karpeg_nomor" id="karpeg_nomor" type=text class="form-control" value="<?=(isset($isi->karpeg_nomor))?$isi->karpeg_nomor:"";?>" disabled>
			</div>
			<!--//col-lg-3-->
			<div class="col-lg-4">
				<label>Tanggal Kartu Pegawai</label>
				<input name="karpeg_tanggal" id="karpeg_tanggal" type=text class="form-control" value="<?=(isset($isi->karpeg_tanggal))?date("d-m-Y", strtotime($isi->karpeg_tanggal)):"";?>" placeholder="dd-mm-YYYY" disabled>
			</div>
			<!--//col-lg-3-->
			<div class="col-lg-4">
				<label>Pejabat penandatangan</label>
				<input name="karpeg_pejabat" id="karpeg_pejabat" type=text class="form-control" value="<?=(isset($isi->karpeg_pejabat))?$isi->karpeg_pejabat:"";?>" disabled>
			</div>
			<!--//col-lg-3-->
		</div>
		<!--//row-->
...
<div class="col-lg-3">
	<div class="panel panel-info">
		<div class="panel-heading"><i class="fa fa-image fa-fw"></i> KARPEG</div>
		<div class="panel-body">
								<div class="thumbnail">
									<div class="caption" style="text-align:center;">
										<p>
										<a href="" class="label label-info" onclick="viewUppl('karpeg','<?=$isi->id_karpeg;?>');return false;"><i class="fa fa-upload fa-fw"></i> Atur Dokumen</a>
										<a href="" class="label label-default" onclick="zoom_dok('karpeg','<?=$isi->id_karpeg;?>');return false;"><i class="fa fa-search fa-fw"></i> Zoom</a>
										</p>
									</div>
...
<div id="komponen_temp" style="display:none;">karpeg</div>
...
function batal_isi(){
	location.href = '<?=site_url();?>module/appbkpp/pegmasuk/karpeg';
}
