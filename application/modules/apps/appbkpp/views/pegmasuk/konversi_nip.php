...
<div class="row">
	<div class="col-lg-12">
		 <h3 class="page-header">Konversi NIP</h3>
	</div><!-- /.col-lg-12 -->
</div><!-- /.row -->

<form role="form" id="form_master" action="<?=site_url();?>appbkpp/profile/konversi_nip_<?=(isset($isi->id_konversi_nip))?"edit":"input";?>_aksi">
<div class="row" id="content_konversi_nip">
<div class="col-lg-9">
<div class="panel panel-info">
	<div class="panel-heading">
		<i class="fa fa-edit fa-fw"></i> <b>Form Konversi NIP</b>
	...
	<div class="panel-body">
		<div class="row">
			<div class="col-lg-3">
				...
				<input name="konversi_nip_nomor" id="konversi_nip_nomor" type=text class="form-control" value="<?=(isset($isi->konversi_nip_nomor))?$isi->konversi_nip_nomor:"";?>" disabled>
			</div>
			<!--//col-lg-3-->
			<div class="col-lg-3">
				<label>Tanggal SK</label>
				<input name="konversi_nip_tanggal" id="konversi_nip_tanggal" type=text class="form-control" value="<?=(isset($isi->konversi_nip_tanggal))?date("d-m-Y", strtotime($isi->konversi_nip_tanggal)):"";?>" placeholder="dd-mm-YYYY" disabled>
			</div>
			<!--//col-lg-3-->
			<div class="col-lg-3">
				<label>Pejabat penandatangan</label>
				<input name="konversi_nip_pejabat" id="konversi_nip_pejabat" type=text class="form-control" value="<?=(isset($isi->konversi_nip_pejabat))?$isi->konversi_nip_pejabat:"";?>" disabled>
			</div>
			<!--//col-lg-3-->
		</div>
		<!--//row-->
...
<div class="col-lg-3">
	<div class="panel panel-info">
		<div class="panel-heading"><i class="fa fa-image fa-fw"></i> Konversi NIP</div>
		<div class="panel-body">
								<div class="thumbnail">
									<div class="caption" style="text-align:center;">
										<p>
										<a href="" class="label label-info" onclick="viewUppl('konversi_nip','<?=$isi->id_konversi_nip;?>');return false;"><i class="fa fa-upload fa-fw"></i> Atur Dokumen</a>
										<a href="" class="label label-default" onclick="zoom_dok('konversi_nip','<?=$isi->id_konversi_nip;?>');return false;"><i class="fa fa-search fa-fw"></i> Zoom</a>
										</p>
									</div>
...
<div id="komponen_temp" style="display:none;">konversi_nip</div>
...
function simpan(){
		var data="";
		var dati="";
				var nama = $.trim($("#konversi_nip_nomor").val());
				var nipb = $.trim($("#konversi_nip_tanggal").val());
				data=data+""+nama+"**";
				if( nama ==""){	dati=dati+"NOMOR SK KONVERSI NIP tidak boleh kosong\n";	}
				if( nipb ==""){	dati=dati+"TANGGAL SK tidak boleh kosong\n";	}
		if( dati !=""){
			alert(dati);
			return false;
		} else { simpan_aksi();	}
...
function batal_isi(){
	location.href = '<?=site_url();?>module/appbkpp/pegmasuk/konversi_nip';
}
