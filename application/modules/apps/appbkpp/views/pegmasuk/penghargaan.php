<div class="row">
	<div class="col-lg-12">
		 <h3 class="page-header">Sertifikat Penghargaan</h3>
	</div><!-- /.col-lg-12 -->
</div><!-- /.row -->
<?=$penghargaan;?>
<div id="komponen_temp" style="display:none;">sertifikat_penghargaan</div>
...
function batal_isi(){
	location.href = '<?=site_url();?>module/appbkpp/pegmasuk/penghargaan';
}
