<div class="row">
	<div class="col-lg-12">
		 <h3 class="page-header">Pendidikan Formal</h3>
	</div><!-- /.col-lg-12 -->
</div><!-- /.row -->
<?=$pendidikan;?>
<div id="komponen_temp" style="display:none;">ijazah_pendidikan</div>
...
function batal_isi(){
	location.href = '<?=site_url();?>module/appbkpp/pegmasuk/pendidikan_formal';
}
