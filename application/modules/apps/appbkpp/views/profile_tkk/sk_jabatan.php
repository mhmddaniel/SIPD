...
<th style="width:100px;text-align:center;vertical-align:middle;">FC. SK TKK</th>
<th style="width:95px;text-align:center;vertical-align:middle;">TMT<br/>KERJA</th>
<th style="width:250px;text-align:center;vertical-align:middle;">UNIT KERJA</th>
<th style="width:555px;text-align:center;vertical-align:middle;">PENUGASAN</th>
</tr>
</thead>
<tbody>
<?=$jabatan;?>
...
function setSubForm(aksi,idd,no){
	$('.btn.batal').click();
		$.ajax({
        type:"POST",
		url:"<?=site_url();?>appbkpp/profile_tkk/formjabatan_"+aksi,
...
function baru(){
	$.ajax({
		type:"POST",
		url: "<?=site_url();?>appbkpp/profile/jabatan_riwayat",
...
function validasi_isian(){
	...
	var dati="";
			...
			if( sknr ==""){	dati=dati+"No. SK TKK tidak boleh kosong\n";	}
