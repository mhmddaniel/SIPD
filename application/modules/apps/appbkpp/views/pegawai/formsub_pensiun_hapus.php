<tr id="brow_tt" class="success prinsip">
	...
	<td id="ipt_keterangan">
		<div>
			...
			<div style="float:left;"><input type="hidden" id="tanggal_pensiun" name="tanggal_pensiun" value="<?=(!isset($val->tanggal_pensiun))?'':$val->tanggal_pensiun;?>"><?=$val->tanggal_pensiun;?></div>
		</div>
		...
		<div style="clear:both;">
			...
			<div style="float:left; width:10px;">:</div>
			<div style="float:left;"><input type="hidden" id="jenis_pensiun" name="jenis_pensiun" value="<?=(!isset($val->jenis_pensiun))?'':$val->jenis_pensiun;?>"><?=$val->jenis_pensiun;?></div>
		</div>
	</td>
</tr>
