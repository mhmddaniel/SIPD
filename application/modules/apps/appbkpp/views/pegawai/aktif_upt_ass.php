...
var mkcpns = $('#a_mkcpns').val();
	...
	//tombol aksi-->
					table = table+ "<td valign=top style='padding:3px 0px 0px 0px;' align=center>";
						...
						table = table+ '<li role="presentation"><a role="menuitem" tabindex="-1" style="cursor:pointer;" onclick="detil('+item.id_pegawai+',\'appevjab/profile_pegjab/pegawai\',\'tidak\');return false;"><i class="fa fa-binoculars fa-fw"></i>Rincian Jabatan Pegawai</a></li>';
