<tr id="row_tt" class="success">
	...
	<td id="ipt_jabatan">
			...
			<div>No. SK</div>
			<div>Tanggal SK</div>
			<div>Instansi Tujuan</div>
	</td>
	<td id="ipt_keterangan">
		<div><input type="text" class="form-control" id="tanggal_keluar" name="tanggal_keluar" value="<?=(!isset($val->tanggal_keluar))?'':$val->tanggal_keluar;?>" placeholder="dd-mm-yyyy" style="width:150px;height:20px;padding:1px 0px 0px 5px;"></div>
		...
		<div><input type="text" class="form-control" id="instansi_tujuan" name="instansi_tujuan" value="<?=(!isset($val->instansi_tujuan))?'':$val->instansi_tujuan;?>" style="width:200px;height:20px;padding:1px 0px 0px 5px;"></div>
	</td>
</tr>
