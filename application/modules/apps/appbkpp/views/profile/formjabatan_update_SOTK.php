<tr id="row_tt" class="success prinsip">
	...
	<td style="padding:0px;">
		...
		?>
		<input type=hidden name="tmt_jabatan" id="tmt_jabatan" value='03-01-2017'>
		<?=form_input('tmt_jabatan_deff','03-01-2017','class="form-control row-fluid" placeholder="dd-mm-yyyy" style="padding-left:5px;padding-right:5px;" id="tmt_jabatan_deff" disabled');?>
	</td>
	<td id="ipt_unor">
			<?php
	...
	<td id="ipt_jabatan">
		<div>
			...
			<div style="float:left;">
				<input type=hidden name="sk_nomor" id="sk_nomor" value=''>
				<input type="text" class="form-control" id="sk_nomor_deff" name="sk_nomor_deff" value="<?=(!isset($val->sk_nomor))?'':$val->sk_nomor;?>" style="width:300px;height:20px;padding:1px 0px 0px 5px;" disabled>
			</div>
		</div>
		<div style="clear:both;">
			...
			<div style="float:left; width:10px;">:</div>
			<div style="float:left;">
				<input type=hidden name="sk_tanggal" id="sk_tanggal" value=''>
				<input type="text" class="form-control" id="sk_tanggal_deff" name="sk_tanggal_deff" value="<?=(!isset($val->sk_tanggal))?'':$val->sk_tanggal;?>" placeholder="dd-mm-yyyy" style="width:150px;height:20px;padding:1px 0px 0px 5px;" disabled>
			</div>
		</div>
		<div style="clear:both;display:table;margin-bottom:5px;">
			...
			<div style="float:left; width:10px;">:</div>
			<div style="float:left;">
				<input type=hidden name="sk_pejabat" id="sk_pejabat" value='Walikota Tangerang'>
				<input type="text" class="form-control" id="sk_pejabat_deff" name="sk_pejabat_deff" value="<?=(!isset($val->sk_pejabat))?'':$val->sk_pejabat;?>" style="width:300px;height:20px;padding:1px 0px 0px 5px;" disabled>
			</div>
		</div>
...
$(document).ready(function(){
	$('#sk_pejabat_deff').val('Walikota Tangerang');
//	pilunor();
});
////////////////////////////////////////////////<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
...
///////////////////////////////////////////////////////////////////////////////
	var kose = $('#kode_ese').val();
	if(kose=="31" || kose=="32" || kose=="22"){	$('#sk_nomor').val('821/Kep.670-BKPP/2016');$('#sk_nomor_deff').val('821/Kep.670-BKPP/2016');	}
	if(kose=="41" || kose=="42"){	$('#sk_nomor').val('821/Kep.671-BKPP/2016');$('#sk_nomor_deff').val('821/Kep.671-BKPP/2016');	}
	$('#sk_tanggal').val('30-12-2016');
	$('#sk_tanggal_deff').val('30-12-2016');
///////////////////////////////////////////////////////////////////////////////
	...
	if(jn_jabatan=="jfu" || jn_jabatan=="jft" || jn_jabatan=="jft-guru"){
		...
		$('#sk_nomor').val('820/Kep.006-BKPSDM/2017');
		$('#sk_nomor_deff').val('820/Kep.006-BKPSDM/2017');
		$('#sk_tanggal').val('03-01-2017');
		$('#sk_tanggal_deff').val('03-01-2017');
	}
}
