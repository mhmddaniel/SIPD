<div class="row" id="content_utama">
  <div class="col-lg-12">
...
if($editable=="yes"){
?>
  <div class="btn btn-warning btn-xs pull-right" onclick="edit_konten('utama','edit','biodata'); return false;"><i class="fa fa-edit fa-fw"></i> Edit</div>
<?php
}
?>
      </div>
