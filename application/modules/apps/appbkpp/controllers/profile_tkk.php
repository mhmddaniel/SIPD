...
class Profile_tkk extends MX_Controller {
...
///////////////////////////////////////////////////////////////////////////////////
	function index(){
		...
		$this->load->view('profile_tkk/index',$data);
	}

	function alih(){
		$this->session->set_userdata('pegawai_info',$_POST['id_pegawai']);
		redirect(site_url("module/appbkpp/profile_tkk"));
	}
	...
	function tkk_ini(){
		...
		$this->load->view('profile_tkk/tkk_ini',$data);
	}
	...
	function formjabatan_tambah(){
		...
		$this->load->view('profile_tkk/formjabatan_update',$data);
	}
	...
	function sk_jabatan(){
		...
		$jabatan = $this->m_profil->ini_pegawai_jabatan($id_pegawai);
			...
			foreach($jabatan as $row){
				...
				$data['jabatan'] .= $this->load->view('profile_tkk/formjabatan_row',array('val'=>$row),true);
				$mulai++;
			}
		$data['no']=$mulai+1;
		...
		$this->load->view('profile_tkk/sk_jabatan',$data);
	}
