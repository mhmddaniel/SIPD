...
class Xls_realisasi_admin extends MX_Controller {
...
$styleArray7b = array(
      'borders' => array(
        ...
        'bottom' => array('style' => PHPExcel_Style_Border::BORDER_HAIR,), 
			...
			$hsl = $this->m_pantau->get_pegawai("",$start,$batas,"all","all","","","","","","","","","","","",$bulan,$tahun);
...
$nip=" ".$val->nip_baru;
	...
	$this->myexcel->getActiveSheet()->setCellValue('G'.$rc, $nilai_kreatifitas);
