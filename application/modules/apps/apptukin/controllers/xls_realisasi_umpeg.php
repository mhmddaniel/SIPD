...
class Xls_realisasi_umpeg extends MX_Controller {
...
$styleArray4 = array(
      'borders' => array(
        ...
        'bottom' => array('style' => PHPExcel_Style_Border::BORDER_DOUBLE,), 
			...
			$hsl = $this->m_pantau->get_pegawai("",$start,$batas,"all",$unor,"","","","","","","","","","","",$bulan,$tahun);


$rc=3;
$periode="PERIODE : bulan ".$dWbulan[$bulan].", tahun ".$tahun;
