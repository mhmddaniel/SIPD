<div class="row">
	<div class="col-lg-12">
		<div class="panel panel-default">
			...
			<span style="margin-left:5px;" id=judul_tpp onclick="jena();"><b>RENCANA KERJA TAHUN <?=$tpp->tahun;?></b></span>
			</div>
...
<div class="row">
	<div class="col-lg-12">
	<h4>Ada catatan untuk pegawai...</h4>
...
<script>
function ajukan(){
	var kegiatan = $("#n_kegiatan").html();
	var biaya = $("#n_biaya").html();
	$.ajax({
	type:"POST",
	url:	$("#pageFormTo").attr("action"),
	data:{"kegiatan":kegiatan,"biaya":biaya},
	beforeSend:function(){	
		$('#btAct').replaceWith('<span id="btAct"><i class="fa fa-spinner fa-spin fa-2x"></i></span>');
	},
	success:function(data){
		location.href = '<?=site_url();?>module/apptukin/rencana_aju';
	},
	dataType:"html"});
	return false;
}
