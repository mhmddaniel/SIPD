	...
	<div class="col-lg-12">
		<div class="panel panel-default">
			<div class="panel-heading">
					...
					<span style="margin-left:5px;" id=judul_tpp><b>DAFTAR ARSIP PERSETUJUAN RENCANA KERJA</b></span>
			</div>
			<div class="panel-body">
<div id="grid-data">
<div class="row">
...
<th style="width:300px;">TAHUN / PERIODE</th>
...
<td id='aksi_<?=$val->id_tpp;?>' align=center>
	<a href="<?=site_url('apptukin/rencana_aju/alih_arsip/'.$val->id_tpp);?>" style="cursor:pointer;"><button class="btn btn-primary dropdown-toggle btn-xs" type="button" id="dropdownMenu1"><i class="fa fa-binoculars fa-fw"></i></button></a>
</td>
