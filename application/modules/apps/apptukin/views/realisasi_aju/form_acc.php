...
<div class="row">
	<div class="col-lg-12">
		<div class="panel panel-danger">
			<div class="panel-heading"><b>CATATAN PERUBAHAN RENCANA KERJA:</b></div>
			<div class="panel-body">
<div class="table-responsive">
...
<table class="table table-striped table-bordered table-hover">
	<thead>
			<tr>
				<td align=center style="background-color:#eee"><b>No.</b></td>
				<td align=center style="background-color:#eee"><b>PEKERJAAN / ALASAN PERUBAHAN</b></td>
				<td align=center style="background-color:#eee"><b>SEBELUM PERUBAHAN</b></td>
				<td align=center style="background-color:#eee"><b>SESUDAH PERUBAHAN</b></td>
			</tr>
	</thead>
	<tbody>
<?php
...
$no++;
$rubah = $val->rubah;
$awal = json_decode($rubah->semula);
?>
			<tr>
				<td><?=$no;?></td>
				<td><?=$val->pekerjaan;?><br><br><b><u>ALASAN PERUBAHAN</u></b><br><?=$rubah->alasan;?></td>
				<td>
				<div style="clear:both;"><div style="float:left;width:105px;">A.K.:</div><div style="float:left;"><?=$awal->$b_ak;?></div></div>
				<div style="clear:both;"><div style="float:left;width:105px;">KUANTITAS:</div><div style="float:left;"><?=$awal->$b_vol;?> <?=$val->satuan;?></div></div>
				<div style="clear:both;"><div style="float:left;width:105px;">KUALITAS:</div><div style="float:left;"><?=$awal->$b_kualitas;?></div></div>
				<div style="clear:both;"><div style="float:left;width:105px;">BIAYA:</div><div style="float:left;"><?=$awal->$b_biaya;?></div></div>
				</td>
				<td>
				<div style="clear:both;"><div style="float:left;width:105px;">A.K.:</div><div style="float:left;"><?=$val->$b_ak;?></div></div>
				<div style="clear:both;"><div style="float:left;width:105px;">KUANTITAS:</div><div style="float:left;"><?=$val->$b_vol;?> <?=$val->satuan;?></div></div>
				<div style="clear:both;"><div style="float:left;width:105px;">KUALITAS:</div><div style="float:left;"><?=$val->$b_kualitas;?></div></div>
				<div style="clear:both;"><div style="float:left;width:105px;">BIAYA:</div><div style="float:left;"><?=$val->$b_biaya;?></div></div>
				</td>
			</tr>
<?php }} ?>
	</tbody>
...
<input type="checkbox" name="setuju" id="setuju" value="setuju"> SETUJU PERUBAHAN
			</div><!-- /.panel-body -->
		</div><!-- /.panel-default -->
	</div><!-- /.col-lg-12 -->
</div><!-- /.row -->
...
<input type="checkbox" name="setuju" id="setuju" value="setuju" checked>
</div>
<?php } ?>
...
if($noCT>1){	$pesan[]="Ada catatan untuk pegawai...!";	}
...
function ajukan(){
	if($("#setuju").is(':checked')){
		...
		var ac = "Perubahan Rencana Kerja BELUM DISETUJUI, Jika Setuju CENTANG tanda \'SETUJU\'";
		alert(ac);
	}
}
