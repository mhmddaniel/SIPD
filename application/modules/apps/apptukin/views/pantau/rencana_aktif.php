	...
	<div style="float:left;">
		<div class="dropdown"><button class="btn btn-primary dropdown-toggle btn-xs" type="button" id="ddMenuT" data-toggle="dropdown"><span class="fa fa-tasks fa-fw"></span></button>
			<ul class="dropdown-menu" role="menu" aria-labelledby="ddMenuT">
				<li role="presentation"><a role="menuitem" tabindex="-1" style="cursor:pointer;" onClick="setForm('pantau/form_tpp_edit','<?=@$tpp->id_tpp;?>','1');"><i class="fa fa-edit fa-fw"></i>Edit Rencana Kerja</a></li>
				<li role="presentation"><a role="menuitem" tabindex="-1" style="cursor:pointer;" onClick="setForm('pantau/form_tpp_hapus','<?=@$tpp->id_tpp;?>','1');"><i class="fa fa-trash fa-fw"></i>Hapus Rencana Kerja</a></li>
				...
				<li role="presentation" class="divider"></li>
				<li role="presentation"><a role="menuitem" tabindex="-1" style="cursor:pointer;" onClick="setForm('pantau/arsip','1','1');"><i class="fa fa-binoculars fa-fw"></i>Lihat Arsip Rencana Kerja</a></li>
			</ul>
		</div>
	</div>
		...
		<div class="panel panel-default" id="panel_penilai">
			<div class="panel-heading">
				...
				<div class="dropdown pull-right">
					...
					<ul class="dropdown-menu" role="menu" aria-labelledby="ddMenuT">
						<li role="presentation"><a role="menuitem" tabindex="-1" style="cursor:pointer;" onClick="setForm('pantau/form_pangkat_penilai','<?=@$tpp->id_tpp;?>','<?=$tpp->id_penilai;?>');"><i class="fa fa-signal fa-fw"></i>Edit Pangkat</a></li>
						<li role="presentation"><a role="menuitem" tabindex="-1" style="cursor:pointer;" onClick="setForm('pantau/form_jabatan_penilai','<?=@$tpp->id_tpp;?>','<?=$tpp->id_penilai;?>');"><i class="fa fa-tasks fa-fw"></i>Edit Jabatan</a></li>
					</ul>
				</div>
			</div>
			<div class="panel-body" style="padding-top:5px; padding-bottom:5px;">
		...
		<div class="panel panel-default" style="margin-bottom:5px;" id="panel_pegawai">
			<div class="panel-heading">
				...
				<div class="dropdown pull-right">
					<div class="btn btn-primary btn-xs" id="ddMenuT" data-toggle="dropdown"><i class="fa fa-edit fa-fw"></i></div>
					<ul class="dropdown-menu" role="menu" aria-labelledby="ddMenuT">
						<li role="presentation"><a role="menuitem" tabindex="-1" style="cursor:pointer;" onClick="setForm('pantau/form_pangkat_pegawai','<?=@$tpp->id_tpp;?>','<?=$tpp->id_pegawai;?>');"><i class="fa fa-signal fa-fw"></i>Edit Pangkat</a></li>
						<li role="presentation"><a role="menuitem" tabindex="-1" style="cursor:pointer;" onClick="setForm('pantau/form_jabatan_pegawai','<?=@$tpp->id_tpp;?>','<?=$tpp->id_pegawai;?>');"><i class="fa fa-tasks fa-fw"></i>Edit Jabatan</a></li>
					</ul>
				</div>
			</div>
			<div class="panel-body" style="padding-top:5px; padding-bottom:5px;">
...
<td id='aksi_<?=$val->id_target;?>' align=center>
	<div class="btn-group" id="btMenu<?=$val->id_target;?>">
		...
		<ul class="dropdown-menu" role="menu">
			<li role="presentation"><a role="menuitem" tabindex="-1" style="cursor:pointer;" onClick="setForm('pantau/edittarget','<?=$val->id_target;?>','<?=$no;?>');"><i class="fa fa-edit fa-fw"></i>Edit data</a></li>
			<li role="presentation" class="divider"></li>
			<li role="presentation"><a role="menuitem" tabindex="-1" style="cursor:pointer;" onClick="setForm('pantau/hapustarget','<?=$val->id_target;?>','<?=$no;?>');"><i class="fa fa-trash fa-fw"></i>Hapus data</a></li>
		</ul>
	</div>
</td>
...
<td id='pekerjaan_xx'>
<button class="btn btn-primary btn-xs" type="button" data-nomor="<?=($no);?>" id='xx' onClick="setForm('pantau/tambahtarget','xx','<?=($no);?>');"><i class="fa fa-plus fa-fw"></i> Tambah kegiatan...</button>
</td>
<td id='ak_xx'>...</td>
<td id='volume_xx'>...</td>
<td id='satuan_xx'>...</td>
