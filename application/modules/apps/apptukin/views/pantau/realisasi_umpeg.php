...
function ppost(idd,act){
	...
	var tab = tab + '<input type="hidden" name="asal" value="pantau/realisasi_umpeg">';
...
function cetak(hal){
	var des = $('#tb_des').html();
	if(des=="ada"){
		window.open("<?=site_url();?>apptukin/xls_realisasi_umpeg_des/index/"+hal,"_blank");
	} else {
		window.open("<?=site_url();?>apptukin/xls_realisasi_umpeg/index/"+hal,"_blank");
	}
}
