...
var tahun = $('#tahun_act').html();
	$.ajax({
		...
		data:{"hal": hal, "batas": batas,"cari":cari,"pns":pns,"kode":kode,"pkt":pkt,"jbt":jbt,"ese":ese,"tugas":tugas,"gender":gender,"agama":agama,"status":status,"jenjang":jenjang,"umur":umur,"mkcpns":mkcpns,"bulan":bulan,"tahun":tahun,"st_rencana":st_rencana,"n_rencana":n_rencana,"n_biaya":n_biaya},
		beforeSend:function(){	
...
function ppost(idd,act){
	...
	var tab = tab + '<input type="hidden" name="asal" value="pantau/rencana_umpeg">';
...
function cetak(hal){
	window.open("<?=site_url();?>apptukin/xls_rencana_umpeg/index/"+hal,"_blank");
}
