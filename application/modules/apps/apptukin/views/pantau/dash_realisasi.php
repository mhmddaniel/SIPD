<div class="row">
	<div class="col-lg-12">
		 <h3 class="page-header">Dashboard Realisasi eKinerja
...
function pilih(pangkat,jenis,eselon,gender,pendidikan,agama,pns,kode,umur,mk,mreal,nreal){
	...
	$('#sb_act2').attr('action','<?=site_url();?>module/apptukin/pantau/realisasi');
	...
	var tab = tab + '<input type="hidden" name="pnlrealisasi" value="'+pnlrealisasi+'">';
	var tab = tab + '<input type="hidden" name="pstrealisasi" value="'+pstrealisasi+'">';
...
function ppost(){
	...
	$('#sb_act2').attr('action','<?=site_url();?>module/apptukin/pantau/dashboard_realisasi');
	var tab = '<input type="hidden" name="bulan" value="'+bulan+'">';
	var tab = tab + '<input type="hidden" name="tahun" value="'+tahun+'">';
	$('#sb_act2').html(tab).submit();
}
