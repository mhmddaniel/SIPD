			...
			<div class="panel-heading">
						...
						<span class="dropdown"><button class="btn btn-default dropdown-toggle btn-xs" type="button" id="ddMenuT" data-toggle="dropdown"><span class="fa fa-graduation-cap fa-fw"></span></button>
							<ul class="dropdown-menu" role="menu" aria-labelledby="ddMenuT">
								<li role="presentation" class="active"><a href="#" role="menuitem"><i class="fa fa-graduation-cap fa-fw"></i> Diklat Prajabatan</a></li>
							...
							<span id="judul"> Daftar Alumni Diklat Prajabatan</span>
						</span>
...
<th style="width:300px;text-align:center; vertical-align:middle">JENIS</th>
<th style="width:300px;text-align:center; vertical-align:middle">JENJANG</th>
...
function zoom_dok(nip_baru,idd){
	...
	var tab = '<input type="hidden" name="komponen" value="sertifikat_prajab">';
