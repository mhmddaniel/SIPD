	...
	<div style="float:left;">
		<div class="dropdown"><button class="btn btn-primary dropdown-toggle btn-xs" type="button" id="ddMenuT" data-toggle="dropdown"><span class="fa fa-refresh fa-fw"></span></button>
			<ul class="dropdown-menu" role="menu" aria-labelledby="ddMenuT">
				...
				<li role="presentation"><a role="menuitem" tabindex="-1" style="cursor:pointer;" onClick="setForm('edit','<?=$diklat->id_diklat_event;?>','1');"><i class="fa fa-edit fa-fw"></i> Edit Rancangan Diklat</a></li>
				<li role="presentation"><a role="menuitem" tabindex="-1" style="cursor:pointer;" onClick="setForm('hapus','<?=$diklat->id_diklat_event;?>','1');"><i class="fa fa-trash fa-fw"></i> Hapus Rancangan Diklat</a></li>
...
function setForm(tujuan,idd,no){
	...
	btt['arsip'] = "<div id='btAct'></div>"; 
			...
			$.ajax({
			type:"POST",
			url:"<?=site_url();?>appdiklat/diklat/"+tujuan,
			data:{"idd": idd },
			beforeSend:function(){	
				$("#pageKonten").hide();
