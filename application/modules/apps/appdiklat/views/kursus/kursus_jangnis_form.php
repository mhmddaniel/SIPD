...
<td>&nbsp;</td>
<td>
<input type="text" name="kode" id="kode" value="<?=@$val->kode;?>" class="form-control" placeholder="Wajib di-isi">
</td>
<td>
...
function simpan_jangnis(aksi){
	...
	$.ajax({
		...
		data:{"idd":"<?=$idd;?>","kode":kode,"nama_diklat_jangnis":nama_diklat_jangnis,"id_rumpun":<?=$id_rumpun;?>,"tipe":"<?=$tipe;?>"},
		beforeSend:function(){	
