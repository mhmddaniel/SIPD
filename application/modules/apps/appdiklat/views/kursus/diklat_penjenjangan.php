			...
			<div class="panel-heading">
						...
						<span class="dropdown"><button class="btn btn-default dropdown-toggle btn-xs" type="button" id="ddMenuT" data-toggle="dropdown"><span class="fa fa-graduation-cap fa-fw"></span></button>
							<ul class="dropdown-menu" role="menu" aria-labelledby="ddMenuT">
								...
								<li class="divider"></li>
								<li role="presentation" class="<?=($rumpun==2)?"active":"";?>"><a href="<?=site_url('module/appdiklat/kursus/diklat_penjenjangan');?>" role="menuitem"><i class="fa fa-<?=($rumpun==2)?"graduation-cap":"tasks";?> fa-fw"></i> Diklat Penjenjangan</a></li>
...
<!--								<li class="divider"></li>
								<li role="presentation" class="<?=($rumpun==8)?"active":"";?>"><a href="<?=site_url('module/appdiklat/kursus/seminar');?>" role="menuitem"><i class="fa fa-<?=($rumpun==8)?"graduation-cap":"tasks";?> fa-fw"></i> Seminar</a></li>
						...
						<span class="btn btn-primary btn-xs pull-right" onclick="setForm('appdiklat/kursus/tambah_diklat_penjenjangan','<?=$nama;?>*0*<?=$rumpun;?>'); return false;"><i class="fa fa-plus fa-fw"></i> Tambah data</span>
...
var jenjang = $('#kode_jenjang_pendidikan').val();
	...
	//tombol aksi-->
					table = table+ "<td valign=top align=center>";
						...
						table = table+ '<li role="presentation"><a role="menuitem" tabindex="-1" style="cursor:pointer;" onClick="setForm(\'appdiklat/kursus/edit_diklat_penjenjangan\',\'<?=$nama;?>*'+item.id_diklat +'*<?=$rumpun;?>\');"><i class="fa fa-edit fa-fw"></i> Edit data</a></li>';
						table = table+ '<li role="presentation"><a role="menuitem" tabindex="-1" style="cursor:pointer;" onClick="setForm(\'appdiklat/kursus/hapus_diklat_penjenjangan\',\'<?=$nama;?>*'+item.id_diklat +'*<?=$rumpun;?>\');"><i class="fa fa-trash fa-fw"></i> Hapus data</a></li>';
						table = table+ "</ul>";
						table = table+ "</div>";
					table = table+ "</td>";
	//tombol aksi<--
