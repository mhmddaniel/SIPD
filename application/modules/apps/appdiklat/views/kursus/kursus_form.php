	...
	<div class="col-lg-6">
		...
		<div class="panel panel-success">
			<div class="panel-heading">
				<i class="fa fa-edit fa-fw"></i> <b>Form <?=ucfirst($aksi);?> <?=ucwords($nama);?></b>
				  ...
				  <div class="row">
					<div class="col-lg-12">
							...
							<div class="form-group">
								...
								<?php
								foreach($jenis_kursus AS $ky=>$vl){	$slc=(isset($val) && @$val->jenis_diklat==$vl)?"selected":"";	echo "<option value='".$ky."' ".$slc.">".$vl."</option>";	}
								?>
								</select>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<label>Jenjang <?=ucwords($nama);?></label>
								<select id="jenjang_kursus" name="jenjang_kursus" class="form-control"  <?=($aksi=="hapus")?"disabled":"";?>>
								<?php
								foreach($jenjang_kursus AS $ky=>$vl){	$slc = (isset($val) && @$val->jenjang_diklat==$vl)?"selected":"";	echo "<option value='".$ky."' ".$slc.">".$vl."</option>";	}
								?>
								</select>
							</div>
