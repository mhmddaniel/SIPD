...
<div class="headertt">
	...
	<div class="container">
		<div class=row>
				<div class="col-lg-8">
					<div style="float:left;padding:10px 10px 10px 0px;"><img src="<?=base_url();?>assets/media/upload/bawaan/Logo_Palembang.png" style='width:80px; vertical-align:middle;'></div>
						...
						<div class="row saru">
                            ...
                            <fieldset>
                                <div class="form-group">
                                    <input class="form-control" placeholder="Isikan Username "  name="ibuku_sayang" value="">
                                </div>
                                <div class="form-group">
                                    <input class="form-control" placeholder="Isikan Password" name="sendok" type="password" value="">
                                </div>
...
<meta http-equiv="refresh" content="0; url=<?=site_url('enable_javascript');?>" />
      ...
      <footer>
        <p>
					Copyright &copy; 2016 - TIM BKPSDM 01 - All Rights Reserved. Page rendered in <strong>{elapsed_time}</strong> seconds
		</p>
      </footer>
    </div>
</body>
